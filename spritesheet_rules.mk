...
$(OBJEVENTGFXDIR)/people/gym_leaders/betti.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
...
$(OBJEVENTGFXDIR)/people/buffoon.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
...
$(OBJEVENTGFXDIR)/people/prof_baro.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
...
$(OBJEVENTGFXDIR)/pokemon/colossio.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
