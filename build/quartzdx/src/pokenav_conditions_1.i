...
bool32 PokenavCallback_Init_7(void)
{
    ...
    if (structPtr == 
# 54 "src/pokenav_conditions_1.c" 3 4
                    ((void *)0)
# 54 "src/pokenav_conditions_1.c"
                        )
        return 0;
...
bool32 PokenavCallback_Init_9(void)
{
    ...
    if (structPtr == 
# 68 "src/pokenav_conditions_1.c" 3 4
                    ((void *)0)
# 68 "src/pokenav_conditions_1.c"
                        )
        return 0;
...
u8 *sub_81CD624(u8 *str, u16 id, bool8 arg3)
{
    ...
    *(str++) = 9;
    ...
    if (GetBoxOrPartyMonData(boxId, monId, 45, 
# 345 "src/pokenav_conditions_1.c" 3 4
                                                           ((void *)0)
# 345 "src/pokenav_conditions_1.c"
                                                               ))
        return StringCopyPadded(str, gText_EggNickname, 0x00, 12);

    GetBoxOrPartyMonData(boxId, monId, 2, str);
    StringGetEnd10(str);
    species = GetBoxOrPartyMonData(boxId, monId, 11, 
# 350 "src/pokenav_conditions_1.c" 3 4
                                                                  ((void *)0)
# 350 "src/pokenav_conditions_1.c"
                                                                      );
    if (boxId == 14)
    {
...
void sub_81CDA1C(s16 arg0, u8 arg1)
{
    ...
    if (arg0 != (sub_81CDD5C() != 0 ? unkPtr->unk0 : unkPtr->unk0 - 1))
    {
        ...
        structPtr->unk6428.unk0[arg1][0] = GetBoxOrPartyMonData(boxId, monId, 22, 
# 496 "src/pokenav_conditions_1.c" 3 4
                                                                                            ((void *)0)
# 496 "src/pokenav_conditions_1.c"
                                                                                                );
        structPtr->unk6428.unk0[arg1][1] = GetBoxOrPartyMonData(boxId, monId, 47, 
# 497 "src/pokenav_conditions_1.c" 3 4
                                                                                             ((void *)0)
# 497 "src/pokenav_conditions_1.c"
                                                                                                 );
        structPtr->unk6428.unk0[arg1][2] = GetBoxOrPartyMonData(boxId, monId, 33, 
# 498 "src/pokenav_conditions_1.c" 3 4
                                                                                             ((void *)0)
# 498 "src/pokenav_conditions_1.c"
                                                                                                 );
        structPtr->unk6428.unk0[arg1][3] = GetBoxOrPartyMonData(boxId, monId, 24, 
# 499 "src/pokenav_conditions_1.c" 3 4
                                                                                            ((void *)0)
# 499 "src/pokenav_conditions_1.c"
                                                                                                );
        structPtr->unk6428.unk0[arg1][4] = GetBoxOrPartyMonData(boxId, monId, 23, 
# 500 "src/pokenav_conditions_1.c" 3 4
                                                                                              ((void *)0)
# 500 "src/pokenav_conditions_1.c"
                                                                                                  );
        structPtr->unk6780[arg1] = (GetBoxOrPartyMonData(boxId, monId, 48, 
# 501 "src/pokenav_conditions_1.c" 3 4
                                                                                      ((void *)0)
# 501 "src/pokenav_conditions_1.c"
                                                                                          ) != 255)
                                 ? GetBoxOrPartyMonData(boxId, monId, 48, 
# 502 "src/pokenav_conditions_1.c" 3 4
                                                                                     ((void *)0)
# 502 "src/pokenav_conditions_1.c"
                                                                                         ) / 29u
                                 : 9;
        structPtr->unk6783[arg1] = GetBoxOrPartyMonData(boxId, monId, 8, 
# 504 "src/pokenav_conditions_1.c" 3 4
                                                                                        ((void *)0)
# 504 "src/pokenav_conditions_1.c"
                                                                                            );
...
void sub_81CDB98(s16 arg0, u8 arg1)
{
    ...
    boxId = unkPtr->unk4[arg0].boxId;
    monId = unkPtr->unk4[arg0].monId;
    species = GetBoxOrPartyMonData(boxId, monId, 65, 
# 530 "src/pokenav_conditions_1.c" 3 4
                                                                   ((void *)0)
# 530 "src/pokenav_conditions_1.c"
                                                                       );
    tid = GetBoxOrPartyMonData(boxId, monId, 1, 
# 531 "src/pokenav_conditions_1.c" 3 4
                                                            ((void *)0)
# 531 "src/pokenav_conditions_1.c"
                                                                );
    personality = GetBoxOrPartyMonData(boxId, monId, 0, 
# 532 "src/pokenav_conditions_1.c" 3 4
                                                                          ((void *)0)
# 532 "src/pokenav_conditions_1.c"
                                                                              );
