...
__attribute__((section("ewram_data"))) static struct RotatingTilePuzzle *sRotatingTilePuzzle = 
# 89 "src/rotating_tile_puzzle.c" 3 4
                                                                  ((void *)0)
# 89 "src/rotating_tile_puzzle.c"
                                                                      ;


void InitRotatingTilePuzzle(bool8 isTrickHouse)
{
    if (sRotatingTilePuzzle == 
# 94 "src/rotating_tile_puzzle.c" 3 4
                              ((void *)0)
# 94 "src/rotating_tile_puzzle.c"
                                  )
...
void FreeRotatingTilePuzzle(void)
{
    ...
    if (sRotatingTilePuzzle != 
# 104 "src/rotating_tile_puzzle.c" 3 4
                              ((void *)0)
# 104 "src/rotating_tile_puzzle.c"
                                  )
        { Free(sRotatingTilePuzzle); sRotatingTilePuzzle = 
# 105 "src/rotating_tile_puzzle.c" 3 4
       ((void *)0)
# 105 "src/rotating_tile_puzzle.c"
       ; };
...
void TurnRotatingTileObjects(void)
{
    ...
    if (sRotatingTilePuzzle == 
# 200 "src/rotating_tile_puzzle.c" 3 4
                              ((void *)0)
# 200 "src/rotating_tile_puzzle.c"
                                  )
        return;
