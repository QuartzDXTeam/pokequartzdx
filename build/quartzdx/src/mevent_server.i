...
__attribute__((section("ewram_data"))) struct mevent_srv_common * s_mevent_srv_common_ptr = 
# 8 "src/mevent_server.c" 3 4
                                                               ((void *)0)
# 8 "src/mevent_server.c"
                                                                   ;
...
{
    u32 result;
    if (s_mevent_srv_common_ptr == 
# 32 "src/mevent_server.c" 3 4
                                  ((void *)0)
# 32 "src/mevent_server.c"
                                      )
        return 3;
...
# 40 "src/mevent_server.c" 3 4
                                 ((void *)0)
# 40 "src/mevent_server.c"
                                     ;
    }
    return result;
}
...
{
    if (a0 != 
# 74 "src/mevent_server.c" 3 4
             ((void *)0)
# 74 "src/mevent_server.c"
                 )
        return a0;
    else
        return a1;
...
static u32 common_mainseq_4(struct mevent_srv_common * svr)
{
    ...
    case 15:
        if (cmd->parameter == 
# 218 "src/mevent_server.c" 3 4
                             ((void *)0)
# 218 "src/mevent_server.c"
                                 )
    ...
    case 18:
        if (cmd->parameter == 
# 224 "src/mevent_server.c" 3 4
                             ((void *)0)
# 224 "src/mevent_server.c"
                                 )
