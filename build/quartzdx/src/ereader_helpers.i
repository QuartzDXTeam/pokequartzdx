...
static bool32 TrainerHill_VerifyChecksum(struct EReaderTrainerHillSet *buffer)
{
    ...
    checksum = CalcByteArraySum((u8 *)buffer->unk_8, sizeof(struct EReaderTrainerHillSet) - 
# 436 "src/ereader_helpers.c" 3 4
                                                                                           __builtin_offsetof (
# 436 "src/ereader_helpers.c"
                                                                                           struct EReaderTrainerHillSet
# 436 "src/ereader_helpers.c" 3 4
                                                                                           , 
# 436 "src/ereader_helpers.c"
...
int EReader_Send(int arg0, u32 *arg1)
{
    ...
    while (1)
    {
        ...
        var1 = EReaderHandleTransfer(1, arg0, arg1, 
# 531 "src/ereader_helpers.c" 3 4
                                                   ((void *)0)
# 531 "src/ereader_helpers.c"
                                                       );
...
int EReader_Recv(u32 *arg0)
{
    ...
    while (1)
    {
        ...
        var1 = EReaderHandleTransfer(0, 0, 
# 574 "src/ereader_helpers.c" 3 4
                                          ((void *)0)
# 574 "src/ereader_helpers.c"
                                              , arg0);
        gUnknown_030012E4 = var1;
        if ((gUnknown_030012E4 & 0x13) == 0x10)
        {
