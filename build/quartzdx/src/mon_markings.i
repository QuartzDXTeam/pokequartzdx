...
static __attribute__((section("ewram_data"))) struct PokemonMarkMenu *sMenu = 
# 285 "src/mon_markings.c" 3 4
                                                 ((void *)0)
# 285 "src/mon_markings.c"
                                                     ;
...
void sub_811FAF8(void)
{
    ...
    for (i = 0; i < 2; i++)
    {
        ...
        sMenu->menuWindowSprites[i] = 
# 372 "src/mon_markings.c" 3 4
                                     ((void *)0)
# 372 "src/mon_markings.c"
                                         ;
    }
    for (i = 0; i < 4; i++)
    {
        ...
        sMenu->menuMarkingSprites[i] = 
# 379 "src/mon_markings.c" 3 4
                                      ((void *)0)
# 379 "src/mon_markings.c"
                                          ;
    }
    if (sMenu->unkSprite)
    {
        ...
        sMenu->unkSprite = 
# 384 "src/mon_markings.c" 3 4
                          ((void *)0)
# 384 "src/mon_markings.c"
                              ;
    }
    if (sMenu->menuTextSprite)
    {
        DestroySprite(sMenu->menuTextSprite);
        sMenu->menuTextSprite = 
# 389 "src/mon_markings.c" 3 4
                               ((void *)0)
# 389 "src/mon_markings.c"
                                   ;
    }
}
...
static void sub_811FC80(s16 x, s16 y, u16 baseTileTag, u16 basePaletteTag)
{
    ...
    struct SpriteSheet sheets[] =
    {
        ...
        { 
# 454 "src/mon_markings.c" 3 4
         ((void *)0)
# 454 "src/mon_markings.c"
             , 0 }
    };
    ...
    struct SpritePalette palettes[] =
    {
        ...
        { 
# 461 "src/mon_markings.c" 3 4
         ((void *)0)
# 461 "src/mon_markings.c"
             , 0 }
    };
...
# 470 "src/mon_markings.c" 3 4
       ((void *)0)
# 470 "src/mon_markings.c"
           ,
    ...
    for (i = 0; i < 2; i++)
    {
        ...
        {
            sMenu->menuWindowSprites[i] = 
# 488 "src/mon_markings.c" 3 4
                                         ((void *)0)
# 488 "src/mon_markings.c"
                                             ;
            return;
        }
    }
    ...
    for (i = 0; i < 4; i++)
    {
        ...
        {
            sMenu->menuMarkingSprites[i] = 
# 511 "src/mon_markings.c" 3 4
                                          ((void *)0)
# 511 "src/mon_markings.c"
                                              ;
            return;
        }
    }
    ...
    {
        sMenu->menuTextSprite = 
# 532 "src/mon_markings.c" 3 4
                               ((void *)0)
# 532 "src/mon_markings.c"
                                   ;
    }
    ...
    {
        sMenu->unkSprite = 
# 545 "src/mon_markings.c" 3 4
                          ((void *)0)
# 545 "src/mon_markings.c"
                              ;
    }
...
static struct Sprite *sub_811FFD4(u16 tileTag, u16 paletteTag, const u16 *palette, u16 size)
{
    ...
    sprTemplate.images = 
# 592 "src/mon_markings.c" 3 4
                        ((void *)0)
# 592 "src/mon_markings.c"
                            ;
    ...
    if (spriteId != 64)
        ...
        return 
# 605 "src/mon_markings.c" 3 4
              ((void *)0)
# 605 "src/mon_markings.c"
                  ;
}
