...
void BattleTv_SetDataBasedOnString(u16 stringId)
{
    ...
    case 221:
        ...
        if (!(gBattleTypeFlags & 0x0002) && GetMonData(defMon, 57, 
# 262 "src/battle_tv.c" 3 4
                                                                                     ((void *)0)
# 262 "src/battle_tv.c"
                                                                                         ) != 0)
            TrySetBattleSeminarShow();
    ...
    case 146:
        ...
        break;
    case 147:
        if (GetMonData(atkMon, 57, 
# 378 "src/battle_tv.c" 3 4
                                           ((void *)0)
# 378 "src/battle_tv.c"
                                               )
...
static void TrySetBattleSeminarShow(void)
{
    ...
    for (i = 0; i < 4; i++)
    {
        if (i != gMoveSelectionCursor[gBattlerAttacker] && dmgByMove[i] > dmgByMove[gMoveSelectionCursor[gBattlerAttacker]])
        {
            ...
            opponentSpecies = GetMonData(&gEnemyParty [gBattlerPartyIndexes[gBattlerTarget]], 11, 
# 1468 "src/battle_tv.c" 3 4
                                                                                                                 ((void *)0)
# 1468 "src/battle_tv.c"
                                                                                                                     );
            playerSpecies = GetMonData(&gPlayerParty[gBattlerPartyIndexes[gBattlerAttacker]], 11, 
# 1469 "src/battle_tv.c" 3 4
                                                                                                                 ((void *)0)
# 1469 "src/battle_tv.c"
                                                                                                                     );
...
u8 GetBattlerMoveSlotId(u8 battlerId, u16 moveId)
{
    ...
    while (1)
    {
        if (i >= 4)
            break;
        if (GetMonData(&party[gBattlerPartyIndexes[battlerId]], 13 + i, 
# 1557 "src/battle_tv.c" 3 4
                                                                                   ((void *)0)
# 1557 "src/battle_tv.c"
                                                                                       ) == moveId)
            break;
        i++;
    }
