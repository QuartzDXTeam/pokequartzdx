...
static const struct SpriteTemplate sCloudSpriteTemplate =
{
    ...
    .images = 
# 91 "src/field_weather_effect.c" 3 4
             ((void *)0)
# 91 "src/field_weather_effect.c"
                 ,
...
# 197 "src/field_weather_effect.c" 3 4
                                                     ((void *)0)
# 197 "src/field_weather_effect.c"
                                                         ;
        }
    }
...
static void DestroyCloudSprites(void)
{
    ...
    for (i = 0; i < 3; i++)
    {
        if (gWeatherPtr->sprites.s1.cloudSprites[i] != 
# 213 "src/field_weather_effect.c" 3 4
                                                      ((void *)0)
# 213 "src/field_weather_effect.c"
                                                          )
...
static const struct SpriteTemplate sRainSpriteTemplate =
{
    ...
    .images = 
# 444 "src/field_weather_effect.c" 3 4
             ((void *)0)
# 444 "src/field_weather_effect.c"
                 ,
    .affineAnims = gDummySpriteAffineAnimTable,
...
# 692 "src/field_weather_effect.c" 3 4
                                                          ((void *)0)
# 692 "src/field_weather_effect.c"
                                                              ;
    }
...
static void DestroyRainSprites(void)
{
    ...
    {
        if (gWeatherPtr->sprites.s1.rainSprites[i] != 
# 743 "src/field_weather_effect.c" 3 4
                                                     ((void *)0)
# 743 "src/field_weather_effect.c"
                                                         )
...
static const struct SpriteTemplate sFogHorizontalSpriteTemplate =
{
    ...
    .images = 
# 1324 "src/field_weather_effect.c" 3 4
             ((void *)0)
# 1324 "src/field_weather_effect.c"
                 ,
...
static void CreateFogHorizontalSprites(void)
{
    ...
    if (!gWeatherPtr->fogHSpritesCreated)
    {
        ...
        for (i = 0; i < 20; i++)
        {
            ...
            {
                gWeatherPtr->sprites.s2.fogHSprites[i] = 
# 1452 "src/field_weather_effect.c" 3 4
                                                        ((void *)0)
# 1452 "src/field_weather_effect.c"
                                                            ;
            }
        }
...
static void DestroyFogHorizontalSprites(void)
{
    ...
    if (gWeatherPtr->fogHSpritesCreated)
    {
        for (i = 0; i < 20; i++)
        {
            if (gWeatherPtr->sprites.s2.fogHSprites[i] != 
# 1468 "src/field_weather_effect.c" 3 4
                                                         ((void *)0)
# 1468 "src/field_weather_effect.c"
                                                             )
...
static const struct SpriteTemplate sAshSpriteTemplate =
{
    ...
    .images = 
# 1610 "src/field_weather_effect.c" 3 4
             ((void *)0)
# 1610 "src/field_weather_effect.c"
                 ,
    .affineAnims = gDummySpriteAffineAnimTable,
...
# 1642 "src/field_weather_effect.c" 3 4
                                                       ((void *)0)
# 1642 "src/field_weather_effect.c"
                                                           ;
            }
        }
...
# 1658 "src/field_weather_effect.c" 3 4
                                                        ((void *)0)
# 1658 "src/field_weather_effect.c"
                                                            )
...
static const struct SpriteTemplate sFogDiagonalSpriteTemplate =
{
    ...
    .images = 
# 1827 "src/field_weather_effect.c" 3 4
             ((void *)0)
# 1827 "src/field_weather_effect.c"
                 ,
    .affineAnims = gDummySpriteAffineAnimTable,
...
static void CreateFogDiagonalSprites(void)
{
    ...
    if (!gWeatherPtr->fogDSpritesCreated)
    {
        ...
        for (i = 0; i < 20; i++)
        {
            ...
            {
                gWeatherPtr->sprites.s2.fogDSprites[i] = 
# 1858 "src/field_weather_effect.c" 3 4
                                                        ((void *)0)
# 1858 "src/field_weather_effect.c"
                                                            ;
            }
        }
...
# 2028 "src/field_weather_effect.c" 3 4
                                                               ((void *)0)
# 2028 "src/field_weather_effect.c"
                                                                   )
...
static const struct SpriteTemplate sSandstormSpriteTemplate =
{
    ...
    .images = 
# 2074 "src/field_weather_effect.c" 3 4
             ((void *)0)
# 2074 "src/field_weather_effect.c"
                 ,
    .affineAnims = gDummySpriteAffineAnimTable,
...
# 2116 "src/field_weather_effect.c" 3 4
                                                              ((void *)0)
# 2116 "src/field_weather_effect.c"
                                                                  ;
            }
        }
...
# 2151 "src/field_weather_effect.c" 3 4
                                                              ((void *)0)
# 2151 "src/field_weather_effect.c"
                                                                  ;
            }
...
static const struct SpriteTemplate sBubbleSpriteTemplate =
{
    ...
    .images = 
# 2329 "src/field_weather_effect.c" 3 4
             ((void *)0)
# 2329 "src/field_weather_effect.c"
                 ,
    .affineAnims = gDummySpriteAffineAnimTable,
