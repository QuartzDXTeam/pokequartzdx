...
static void RecordedOpponentHandleChoosePokemon(void)
{
    *(gBattleStruct->monToSwitchIntoId + gActiveBattler) = RecordedBattle_GetBattlerAction(gActiveBattler);
    BtlController_EmitChosenMonReturnValue(1, *(gBattleStruct->monToSwitchIntoId + gActiveBattler), 
# 1440 "src/battle_controller_recorded_opponent.c" 3 4
                                                                                                   ((void *)0)
# 1440 "src/battle_controller_recorded_opponent.c"
                                                                                                       );
    RecordedOpponentBufferExecCompleted();
}
