...
void FreeBattleResources(void)
{
    ...
    if (gBattleResources != 
# 51 "src/battle_util2.c" 3 4
                           ((void *)0)
# 51 "src/battle_util2.c"
                               )
    {
        { Free(gBattleStruct); gBattleStruct = 
# 53 "src/battle_util2.c" 3 4
       ((void *)0)
# 53 "src/battle_util2.c"
       ; };

        { Free(gBattleResources->secretBase); gBattleResources->secretBase = 
# 55 "src/battle_util2.c" 3 4
       ((void *)0)
# 55 "src/battle_util2.c"
       ; };
        { Free(gBattleResources->flags); gBattleResources->flags = 
# 56 "src/battle_util2.c" 3 4
       ((void *)0)
# 56 "src/battle_util2.c"
       ; };
        { Free(gBattleResources->battleScriptsStack); gBattleResources->battleScriptsStack = 
# 57 "src/battle_util2.c" 3 4
       ((void *)0)
# 57 "src/battle_util2.c"
       ; };
        { Free(gBattleResources->battleCallbackStack); gBattleResources->battleCallbackStack = 
# 58 "src/battle_util2.c" 3 4
       ((void *)0)
# 58 "src/battle_util2.c"
       ; };
        { Free(gBattleResources->beforeLvlUp); gBattleResources->beforeLvlUp = 
# 59 "src/battle_util2.c" 3 4
       ((void *)0)
# 59 "src/battle_util2.c"
       ; };
        { Free(gBattleResources->ai); gBattleResources->ai = 
# 60 "src/battle_util2.c" 3 4
       ((void *)0)
# 60 "src/battle_util2.c"
       ; };
        { Free(gBattleResources->battleHistory); gBattleResources->battleHistory = 
# 61 "src/battle_util2.c" 3 4
       ((void *)0)
# 61 "src/battle_util2.c"
       ; };
        { Free(gBattleResources->AI_ScriptsStack); gBattleResources->AI_ScriptsStack = 
# 62 "src/battle_util2.c" 3 4
       ((void *)0)
# 62 "src/battle_util2.c"
       ; };
        { Free(gBattleResources); gBattleResources = 
# 63 "src/battle_util2.c" 3 4
       ((void *)0)
# 63 "src/battle_util2.c"
       ; };

        { Free(gLinkBattleSendBuffer); gLinkBattleSendBuffer = 
# 65 "src/battle_util2.c" 3 4
       ((void *)0)
# 65 "src/battle_util2.c"
       ; };
        { Free(gLinkBattleRecvBuffer); gLinkBattleRecvBuffer = 
# 66 "src/battle_util2.c" 3 4
       ((void *)0)
# 66 "src/battle_util2.c"
       ; };

        { Free(gUnknown_0202305C); gUnknown_0202305C = 
# 68 "src/battle_util2.c" 3 4
       ((void *)0)
# 68 "src/battle_util2.c"
       ; };
        { Free(gUnknown_02023060); gUnknown_02023060 = 
# 69 "src/battle_util2.c" 3 4
       ((void *)0)
# 69 "src/battle_util2.c"
       ; };
    }
}
