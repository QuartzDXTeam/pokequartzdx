...
u8 *GetSavedRamScriptIfValid(void)
{
    ...
    if (!ValidateReceivedWonderCard())
        return 
# 409 "src/script.c" 3 4
              ((void *)0)
# 409 "src/script.c"
                  ;
    if (scriptData->magic != 51)
        return 
# 411 "src/script.c" 3 4
              ((void *)0)
# 411 "src/script.c"
                  ;
    if (scriptData->mapGroup != 0xFF)
        return 
# 413 "src/script.c" 3 4
              ((void *)0)
# 413 "src/script.c"
                  ;
    if (scriptData->mapNum != 0xFF)
        return 
# 415 "src/script.c" 3 4
              ((void *)0)
# 415 "src/script.c"
                  ;
    if (scriptData->objectId != 0xFF)
        return 
# 417 "src/script.c" 3 4
              ((void *)0)
# 417 "src/script.c"
                  ;
    if (CalculateRamScriptChecksum() != gSaveBlock1Ptr->ramScript.checksum)
