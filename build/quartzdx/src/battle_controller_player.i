...
static void WaitForMonSelection(void)
{
    if (gMain.callback2 == BattleMainCB2 && !gPaletteFade.active)
    {
        if (gPartyMenuUseExitCallback == 1)
            ...
            BtlController_EmitChosenMonReturnValue(1, 6, 
# 1348 "src/battle_controller_player.c" 3 4
                                                                 ((void *)0)
# 1348 "src/battle_controller_player.c"
                                                                     );
...
static void PlayerHandleChosenMonReturnValue(void)
{
    BtlController_EmitChosenMonReturnValue(1, 0, 
# 2812 "src/battle_controller_player.c" 3 4
                                                ((void *)0)
# 2812 "src/battle_controller_player.c"
                                                    );
    PlayerBufferExecCompleted();
}
