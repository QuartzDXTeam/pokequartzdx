...
bool32 sub_800F4F0(void)
{
    ...
    if (lman.childClockSlave_flag == 0 && Rfu.unk_ce4)
    {
        ...
        gReceivedRemoteLinkPlayers = 0;
        Rfu.linkRfuCallback = 
# 839 "src/link_rfu_2.c" 3 4
                             ((void *)0)
# 839 "src/link_rfu_2.c"
                                 ;
        if (Rfu.unk_ce4 == 1)
        {
            sub_8011A64(2, 0x9000);
...
{
    Rfu.linkRfuCallback = 
# 944 "src/link_rfu_2.c" 3 4
                         ((void *)0)
# 944 "src/link_rfu_2.c"
                             ;
}
...
# 957 "src/link_rfu_2.c" 3 4
                              ((void *)0)
# 957 "src/link_rfu_2.c"
                                  )
...
void sub_800FCC4(struct UnkRfuStruct_2_Sub_6c *data)
{
    ...
    data->unk_02 = 0;
    data->unk_04 = 
# 1095 "src/link_rfu_2.c" 3 4
                  ((void *)0)
# 1095 "src/link_rfu_2.c"
                      ;
    data->unk_08 = 0;
    data->unk_10 = 0;
    data->unk_11 = 0;
...
bool32 sub_800FE84(const u8 *src, size_t size)
{
    bool8 r4;
    if (Rfu.linkRfuCallback != 
# 1177 "src/link_rfu_2.c" 3 4
                              ((void *)0)
# 1177 "src/link_rfu_2.c"
                                  )
        return 0;
    if (gSendCmd[0] != 0)
        return 0;
    ...
    if (Rfu.unk_0c == 0)
    {
        ...
        if ((u8)gRecvCmds[mpId][0] == Rfu.unk_6c.unk_02 - 1)
        {
            if (Rfu.unk_80[mpId].unk_08 != gUnknown_082ED628[Rfu.unk_80[mpId].unk_02])
            {
                ...
                Rfu.linkRfuCallback = 
# 1256 "src/link_rfu_2.c" 3 4
                                     ((void *)0)
# 1256 "src/link_rfu_2.c"
                                         ;
        }
    }
    else
        Rfu.linkRfuCallback = 
# 1260 "src/link_rfu_2.c" 3 4
                             ((void *)0)
# 1260 "src/link_rfu_2.c"
                                 ;
}
...
void sub_801011C(void)
{
    ...
    Rfu.unk_ef = 1;
    Rfu.linkRfuCallback = 
# 1276 "src/link_rfu_2.c" 3 4
                         ((void *)0)
# 1276 "src/link_rfu_2.c"
                             ;
}
...
{
    if (Rfu.linkRfuCallback == 
# 1339 "src/link_rfu_2.c" 3 4
                              ((void *)0)
# 1339 "src/link_rfu_2.c"
                                  )
    {
        Rfu.unk_cd9 = 1;
...
void sub_80102B8(void)
{
    ...
    if (i == playerCount)
    {
        ...
        Rfu.unk_100++;
        Rfu.linkRfuCallback = 
# 1378 "src/link_rfu_2.c" 3 4
                             ((void *)0)
# 1378 "src/link_rfu_2.c"
                                 ;
    }
    Rfu.unk_fe++;
}
...
{
    if (Rfu.linkRfuCallback == 
# 1426 "src/link_rfu_2.c" 3 4
                              ((void *)0)
# 1426 "src/link_rfu_2.c"
                                  )
    {
...
void sub_80111DC(void)
{
    ...
    Rfu.linkRfuCallback = 
# 2015 "src/link_rfu_2.c" 3 4
                         ((void *)0)
# 2015 "src/link_rfu_2.c"
                             ;
}
...
void sub_8011C10(u32 a0)
{
    Rfu.unk_0c = 1;
    sub_8010F48();
    rfu_LMAN_initializeManager(sub_801120C, 
# 2457 "src/link_rfu_2.c" 3 4
                                           ((void *)0)
# 2457 "src/link_rfu_2.c"
                                               );
...
void sub_8011C84(void)
{
    Rfu.unk_0c = 2;
    sub_8010F48();
    rfu_LMAN_initializeManager(sub_8011674, 
# 2475 "src/link_rfu_2.c" 3 4
                                           ((void *)0)
# 2475 "src/link_rfu_2.c"
                                               );
    gUnknown_02022B2C = gUnknown_082ED608;
