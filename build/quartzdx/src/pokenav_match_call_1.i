...
const u8 gText_MatchCallQueenBee_Betti_Strategy[] = _("I use my intellect!");
const u8 gText_MatchCallQueenBee_Betti_Pokemon[] = _("Any Bug-type Pokémon.");
const u8 gText_MatchCallQueenBee_Betti_Intro1[] = _("I'm gonna break out of");
const u8 gText_MatchCallQueenBee_Betti_Intro2[] = _("my cocoon one day!");
...
{
    [REMATCH_ROSE] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallPainter_Rose_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallPainter_Rose_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallPainter_Rose_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallPainter_Rose_Intro2},
    ...
    [REMATCH_VALERIE] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallBuffoon_Valerie_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallBuffoon_Valerie_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallBuffoon_Valerie_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallBuffoon_Valerie_Intro2},
    ...
    [REMATCH_BETTI] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallQueenBee_Betti_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallQueenBee_Betti_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallQueenBee_Betti_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallQueenBee_Betti_Intro2},
...
void BufferMatchCallNameAndDesc(struct PokenavMatchCallEntries *matchCallEntry, u8 *str)
{
    ...
    {
        sub_81DB494(str, 7, 
# 422 "src/pokenav_match_call_1.c" 3 4
                           ((void *)0)
# 422 "src/pokenav_match_call_1.c"
                               , 120);
    }
}
