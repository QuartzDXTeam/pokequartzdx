...
__attribute__((section("ewram_data"))) struct BattleMsgData *gBattleMsgDataPtr = 
# 52 "src/battle_message.c" 3 4
                                                    ((void *)0)
# 52 "src/battle_message.c"
                                                        ;
...
void BufferStringBattle(u16 stringID)
{
    s32 i;
    const u8 *stringPtr = 
# 1942 "src/battle_message.c" 3 4
                         ((void *)0)
# 1942 "src/battle_message.c"
                             ;
...
static const u8* TryGetStatusString(u8 *src)
{
    ...
    return 
# 2264 "src/battle_message.c" 3 4
          ((void *)0)
# 2264 "src/battle_message.c"
              ;
}
...
u32 BattleStringExpandPlaceholders(const u8 *src, u8 *dst)
{
    u32 dstID = 0;
    const u8 *toCpy = 
# 2292 "src/battle_message.c" 3 4
                     ((void *)0)
# 2292 "src/battle_message.c"
                         ;
    u8 text[30];
    u8 multiplayerId;
    s32 i;
        ...
        if (*src == 0xFD)
        {
            ...
            case 0x0:
                ...
                else
                {
                    ...
                    if (toCpy == 
# 2318 "src/battle_message.c" 3 4
                                ((void *)0)
# 2318 "src/battle_message.c"
                                    )
...
void BattlePutTextOnWindow(const u8 *text, u8 windowId)
{
    ...
    AddTextPrinter(&printerTemplate, speed, 
# 2994 "src/battle_message.c" 3 4
                                           ((void *)0)
# 2994 "src/battle_message.c"
                                               );
