...
static __attribute__((section("ewram_data"))) struct SecretBaseRegistryMenu *sRegistryMenu = 
# 73 "src/secret_base.c" 3 4
                                                                ((void *)0)
# 73 "src/secret_base.c"
                                                                    ;
...
{
    .items = 
# 190 "src/secret_base.c" 3 4
            ((void *)0)
# 190 "src/secret_base.c"
                ,
    .moveCursorFunc = RegistryMenu_OnCursorMove,
    .itemPrintFunc = 
# 192 "src/secret_base.c" 3 4
                    ((void *)0)
# 192 "src/secret_base.c"
                        ,
    .totalItems = 0,
    .maxShowed = 0,
    .windowId = 0,
...
# 973 "src/secret_base.c" 3 4
                                    ((void *)0)
# 973 "src/secret_base.c"
                                        , 
# 973 "src/secret_base.c" 3 4
                                          ((void *)0)
# 973 "src/secret_base.c"
