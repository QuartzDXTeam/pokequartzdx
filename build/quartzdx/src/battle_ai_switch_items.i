...
# 42 "src/battle_ai_switch_items.c" 3 4
                           ((void *)0)
# 42 "src/battle_ai_switch_items.c"
                               ;
    u16 move;
...
static bool8 ShouldUseItem(void)
{
    ...
    for (i = 0; i < 4; i++)
    {
        ...
        if (item == 0)
            continue;
        if (gItemEffectTable[item - 13] == 
# 835 "src/battle_ai_switch_items.c" 3 4
                                                   ((void *)0)
# 835 "src/battle_ai_switch_items.c"
                                                       )
            continue;
