...
void SetTaskFuncWithFollowupFunc(u8 taskId, TaskFunc func, TaskFunc followupFunc)
{
    { u32 tasksAddr = (u32)gTasks; u32 addr = taskId * sizeof(struct Task) + 28; u32 dataAddr = tasksAddr + 
# 150 "src/task.c" 3 4
   __builtin_offsetof (
# 150 "src/task.c"
   struct Task
...
# 150 "src/task.c"
   ; addr += dataAddr; *((u16 *)addr) = (u32)followupFunc; }
    { u32 tasksAddr = (u32)gTasks; u32 addr = taskId * sizeof(struct Task) + 30; u32 dataAddr = tasksAddr + 
# 151 "src/task.c" 3 4
   __builtin_offsetof (
# 151 "src/task.c"
   struct Task
...
# 151 "src/task.c"
   ; addr += dataAddr; *((u16 *)addr) = (u32)followupFunc >> 16; }
...
# 162 "src/task.c"
   ; addr += dataAddr; func |= *((s16 *)addr) << 16; }
