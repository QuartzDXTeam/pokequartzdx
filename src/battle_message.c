...
static const u8 sText_DontLeaveBaro[] = _("Prof. Baro: Don't leave me like this!\p");
...
const u8 * const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_DONTLEAVEBARO - 12] = sText_DontLeaveBaro,
...
const u16 gNoEscapeStringIds[] =
{
    ...
    [B_MSG_DONT_LEAVE_BARO]     = STRINGID_DONTLEAVEBARO,
...
const u8 gText_BattleWallyName[] = _("Ramón");
...
const u8 gText_TheUnbeatenChampion[] = _("The undefeated Champion!\p");
