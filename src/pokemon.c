...
#define SPECIES_TO_CORNA(name)      [SPECIES_##name - 1] = CORNA_DEX_##name
#define SPECIES_TO_NATIONAL(name)   [SPECIES_##name - 1] = NATIONAL_DEX_##name
#define CORNA_TO_NATIONAL(name)     [CORNA_DEX_##name - 1] = NATIONAL_DEX_##name

const u16 gSpeciesToCornaPokedexNum[] = // Assigns all species to the Corna Dex Index (Summary No. for Corna Dex)
{
    SPECIES_TO_CORNA(BULBASAUR),
    SPECIES_TO_CORNA(IVYSAUR),
    SPECIES_TO_CORNA(VENUSAUR),
    SPECIES_TO_CORNA(CHARMANDER),
    SPECIES_TO_CORNA(CHARMELEON),
    SPECIES_TO_CORNA(CHARIZARD),
    SPECIES_TO_CORNA(SQUIRTLE),
    SPECIES_TO_CORNA(WARTORTLE),
    SPECIES_TO_CORNA(BLASTOISE),
    SPECIES_TO_CORNA(CATERPIE),
    SPECIES_TO_CORNA(METAPOD),
    SPECIES_TO_CORNA(BUTTERFREE),
    SPECIES_TO_CORNA(WEEDLE),
    SPECIES_TO_CORNA(KAKUNA),
    SPECIES_TO_CORNA(BEEDRILL),
    SPECIES_TO_CORNA(PIDGEY),
    SPECIES_TO_CORNA(PIDGEOTTO),
    SPECIES_TO_CORNA(PIDGEOT),
    SPECIES_TO_CORNA(RATTATA),
    SPECIES_TO_CORNA(RATICATE),
    SPECIES_TO_CORNA(SPEAROW),
    SPECIES_TO_CORNA(FEAROW),
    SPECIES_TO_CORNA(EKANS),
    SPECIES_TO_CORNA(ARBOK),
    SPECIES_TO_CORNA(PIKACHU),
    SPECIES_TO_CORNA(RAICHU),
    SPECIES_TO_CORNA(SANDSHREW),
    SPECIES_TO_CORNA(SANDSLASH),
    SPECIES_TO_CORNA(NIDORAN_F),
    SPECIES_TO_CORNA(NIDORINA),
    SPECIES_TO_CORNA(NIDOQUEEN),
    SPECIES_TO_CORNA(NIDORAN_M),
    SPECIES_TO_CORNA(NIDORINO),
    SPECIES_TO_CORNA(NIDOKING),
    SPECIES_TO_CORNA(CLEFAIRY),
    SPECIES_TO_CORNA(CLEFABLE),
    SPECIES_TO_CORNA(VULPIX),
    SPECIES_TO_CORNA(NINETALES),
    SPECIES_TO_CORNA(JIGGLYPUFF),
    SPECIES_TO_CORNA(WIGGLYTUFF),
    SPECIES_TO_CORNA(ZUBAT),
    SPECIES_TO_CORNA(GOLBAT),
    SPECIES_TO_CORNA(ODDISH),
    SPECIES_TO_CORNA(GLOOM),
    SPECIES_TO_CORNA(VILEPLUME),
    SPECIES_TO_CORNA(PARAS),
    SPECIES_TO_CORNA(PARASECT),
    SPECIES_TO_CORNA(VENONAT),
    SPECIES_TO_CORNA(VENOMOTH),
    SPECIES_TO_CORNA(DIGLETT),
    SPECIES_TO_CORNA(DUGTRIO),
    SPECIES_TO_CORNA(MEOWTH),
    SPECIES_TO_CORNA(PERSIAN),
    SPECIES_TO_CORNA(PSYDUCK),
    SPECIES_TO_CORNA(GOLDUCK),
    SPECIES_TO_CORNA(MANKEY),
    SPECIES_TO_CORNA(PRIMEAPE),
    SPECIES_TO_CORNA(GROWLITHE),
    SPECIES_TO_CORNA(ARCANINE),
    SPECIES_TO_CORNA(POLIWAG),
    SPECIES_TO_CORNA(POLIWHIRL),
    SPECIES_TO_CORNA(POLIWRATH),
    SPECIES_TO_CORNA(ABRA),
    SPECIES_TO_CORNA(KADABRA),
    SPECIES_TO_CORNA(ALAKAZAM),
    SPECIES_TO_CORNA(MACHOP),
    SPECIES_TO_CORNA(MACHOKE),
    SPECIES_TO_CORNA(MACHAMP),
    SPECIES_TO_CORNA(BELLSPROUT),
    SPECIES_TO_CORNA(WEEPINBELL),
    SPECIES_TO_CORNA(VICTREEBEL),
    SPECIES_TO_CORNA(TENTACOOL),
    SPECIES_TO_CORNA(TENTACRUEL),
    SPECIES_TO_CORNA(GEODUDE),
    SPECIES_TO_CORNA(GRAVELER),
    SPECIES_TO_CORNA(GOLEM),
    SPECIES_TO_CORNA(PONYTA),
    SPECIES_TO_CORNA(RAPIDASH),
    SPECIES_TO_CORNA(SLOWPOKE),
    SPECIES_TO_CORNA(SLOWBRO),
    SPECIES_TO_CORNA(MAGNEMITE),
    SPECIES_TO_CORNA(MAGNETON),
    SPECIES_TO_CORNA(FARFETCHD),
    SPECIES_TO_CORNA(DODUO),
    SPECIES_TO_CORNA(DODRIO),
    SPECIES_TO_CORNA(SEEL),
    SPECIES_TO_CORNA(DEWGONG),
    SPECIES_TO_CORNA(GRIMER),
    SPECIES_TO_CORNA(MUK),
    SPECIES_TO_CORNA(SHELLDER),
    SPECIES_TO_CORNA(CLOYSTER),
    SPECIES_TO_CORNA(GASTLY),
    SPECIES_TO_CORNA(HAUNTER),
    SPECIES_TO_CORNA(GENGAR),
    SPECIES_TO_CORNA(ONIX),
    SPECIES_TO_CORNA(DROWZEE),
    SPECIES_TO_CORNA(HYPNO),
    SPECIES_TO_CORNA(KRABBY),
    SPECIES_TO_CORNA(KINGLER),
    SPECIES_TO_CORNA(VOLTORB),
    SPECIES_TO_CORNA(ELECTRODE),
    SPECIES_TO_CORNA(EXEGGCUTE),
    SPECIES_TO_CORNA(EXEGGUTOR),
    SPECIES_TO_CORNA(CUBONE),
    SPECIES_TO_CORNA(MAROWAK),
    SPECIES_TO_CORNA(HITMONLEE),
    SPECIES_TO_CORNA(HITMONCHAN),
    SPECIES_TO_CORNA(LICKITUNG),
    SPECIES_TO_CORNA(KOFFING),
    SPECIES_TO_CORNA(WEEZING),
    SPECIES_TO_CORNA(RHYHORN),
    SPECIES_TO_CORNA(RHYDON),
    SPECIES_TO_CORNA(CHANSEY),
    SPECIES_TO_CORNA(TANGELA),
    SPECIES_TO_CORNA(KANGASKHAN),
    SPECIES_TO_CORNA(HORSEA),
    SPECIES_TO_CORNA(SEADRA),
    SPECIES_TO_CORNA(GOLDEEN),
    SPECIES_TO_CORNA(SEAKING),
    SPECIES_TO_CORNA(STARYU),
    SPECIES_TO_CORNA(STARMIE),
    SPECIES_TO_CORNA(MR_MIME),
    SPECIES_TO_CORNA(SCYTHER),
    SPECIES_TO_CORNA(JYNX),
    SPECIES_TO_CORNA(ELECTABUZZ),
    SPECIES_TO_CORNA(MAGMAR),
    SPECIES_TO_CORNA(PINSIR),
    SPECIES_TO_CORNA(TAUROS),
    SPECIES_TO_CORNA(MAGIKARP),
    SPECIES_TO_CORNA(GYARADOS),
    SPECIES_TO_CORNA(LAPRAS),
    SPECIES_TO_CORNA(DITTO),
    SPECIES_TO_CORNA(EEVEE),
    SPECIES_TO_CORNA(VAPOREON),
    SPECIES_TO_CORNA(JOLTEON),
    SPECIES_TO_CORNA(FLAREON),
    SPECIES_TO_CORNA(PORYGON),
    SPECIES_TO_CORNA(OMANYTE),
    SPECIES_TO_CORNA(OMASTAR),
    SPECIES_TO_CORNA(KABUTO),
    SPECIES_TO_CORNA(KABUTOPS),
    SPECIES_TO_CORNA(AERODACTYL),
    SPECIES_TO_CORNA(SNORLAX),
    SPECIES_TO_CORNA(ARTICUNO),
    SPECIES_TO_CORNA(ZAPDOS),
    SPECIES_TO_CORNA(MOLTRES),
    SPECIES_TO_CORNA(DRATINI),
    SPECIES_TO_CORNA(DRAGONAIR),
    SPECIES_TO_CORNA(DRAGONITE),
    SPECIES_TO_CORNA(MEWTWO),
    SPECIES_TO_CORNA(MEW),
    SPECIES_TO_CORNA(CHIKORITA),
    SPECIES_TO_CORNA(BAYLEEF),
    SPECIES_TO_CORNA(MEGANIUM),
    SPECIES_TO_CORNA(CYNDAQUIL),
    SPECIES_TO_CORNA(QUILAVA),
    SPECIES_TO_CORNA(TYPHLOSION),
    SPECIES_TO_CORNA(TOTODILE),
    SPECIES_TO_CORNA(CROCONAW),
    SPECIES_TO_CORNA(FERALIGATR),
    SPECIES_TO_CORNA(SENTRET),
    SPECIES_TO_CORNA(FURRET),
    SPECIES_TO_CORNA(HOOTHOOT),
    SPECIES_TO_CORNA(NOCTOWL),
    SPECIES_TO_CORNA(LEDYBA),
    SPECIES_TO_CORNA(LEDIAN),
    SPECIES_TO_CORNA(SPINARAK),
    SPECIES_TO_CORNA(ARIADOS),
    SPECIES_TO_CORNA(CROBAT),
    SPECIES_TO_CORNA(CHINCHOU),
    SPECIES_TO_CORNA(LANTURN),
    SPECIES_TO_CORNA(PICHU),
    SPECIES_TO_CORNA(CLEFFA),
    SPECIES_TO_CORNA(IGGLYBUFF),
    SPECIES_TO_CORNA(TOGEPI),
    SPECIES_TO_CORNA(TOGETIC),
    SPECIES_TO_CORNA(NATU),
    SPECIES_TO_CORNA(XATU),
    SPECIES_TO_CORNA(MAREEP),
    SPECIES_TO_CORNA(FLAAFFY),
    SPECIES_TO_CORNA(AMPHAROS),
    SPECIES_TO_CORNA(BELLOSSOM),
    SPECIES_TO_CORNA(MARILL),
    SPECIES_TO_CORNA(AZUMARILL),
    SPECIES_TO_CORNA(SUDOWOODO),
    SPECIES_TO_CORNA(POLITOED),
    SPECIES_TO_CORNA(HOPPIP),
    SPECIES_TO_CORNA(SKIPLOOM),
    SPECIES_TO_CORNA(JUMPLUFF),
    SPECIES_TO_CORNA(AIPOM),
    SPECIES_TO_CORNA(SUNKERN),
    SPECIES_TO_CORNA(SUNFLORA),
    SPECIES_TO_CORNA(YANMA),
    SPECIES_TO_CORNA(WOOPER),
    SPECIES_TO_CORNA(QUAGSIRE),
    SPECIES_TO_CORNA(ESPEON),
    SPECIES_TO_CORNA(UMBREON),
    SPECIES_TO_CORNA(MURKROW),
    SPECIES_TO_CORNA(SLOWKING),
    SPECIES_TO_CORNA(MISDREAVUS),
    SPECIES_TO_CORNA(UNOWN),
    SPECIES_TO_CORNA(WOBBUFFET),
    SPECIES_TO_CORNA(GIRAFARIG),
    SPECIES_TO_CORNA(PINECO),
    SPECIES_TO_CORNA(FORRETRESS),
    SPECIES_TO_CORNA(DUNSPARCE),
    SPECIES_TO_CORNA(GLIGAR),
    SPECIES_TO_CORNA(STEELIX),
    SPECIES_TO_CORNA(SNUBBULL),
    SPECIES_TO_CORNA(GRANBULL),
    SPECIES_TO_CORNA(QWILFISH),
    SPECIES_TO_CORNA(SCIZOR),
    SPECIES_TO_CORNA(SHUCKLE),
    SPECIES_TO_CORNA(HERACROSS),
    SPECIES_TO_CORNA(SNEASEL),
    SPECIES_TO_CORNA(TEDDIURSA),
    SPECIES_TO_CORNA(URSARING),
    SPECIES_TO_CORNA(SLUGMA),
    SPECIES_TO_CORNA(MAGCARGO),
    SPECIES_TO_CORNA(SWINUB),
    SPECIES_TO_CORNA(PILOSWINE),
    SPECIES_TO_CORNA(CORSOLA),
    SPECIES_TO_CORNA(REMORAID),
    SPECIES_TO_CORNA(OCTILLERY),
    SPECIES_TO_CORNA(DELIBIRD),
    SPECIES_TO_CORNA(MANTINE),
    SPECIES_TO_CORNA(SKARMORY),
    SPECIES_TO_CORNA(HOUNDOUR),
    SPECIES_TO_CORNA(HOUNDOOM),
    SPECIES_TO_CORNA(KINGDRA),
    SPECIES_TO_CORNA(PHANPY),
    SPECIES_TO_CORNA(DONPHAN),
    SPECIES_TO_CORNA(PORYGON2),
    SPECIES_TO_CORNA(STANTLER),
    SPECIES_TO_CORNA(SMEARGLE),
    SPECIES_TO_CORNA(TYROGUE),
    SPECIES_TO_CORNA(HITMONTOP),
    SPECIES_TO_CORNA(SMOOCHUM),
    SPECIES_TO_CORNA(ELEKID),
    SPECIES_TO_CORNA(MAGBY),
    SPECIES_TO_CORNA(MILTANK),
    SPECIES_TO_CORNA(BLISSEY),
    SPECIES_TO_CORNA(RAIKOU),
    SPECIES_TO_CORNA(ENTEI),
    SPECIES_TO_CORNA(SUICUNE),
    SPECIES_TO_CORNA(LARVITAR),
    SPECIES_TO_CORNA(PUPITAR),
    SPECIES_TO_CORNA(TYRANITAR),
    SPECIES_TO_CORNA(LUGIA),
    SPECIES_TO_CORNA(HO_OH),
    SPECIES_TO_CORNA(CELEBI),
    SPECIES_TO_CORNA(OLD_UNOWN_B),
    SPECIES_TO_CORNA(OLD_UNOWN_C),
    SPECIES_TO_CORNA(OLD_UNOWN_D),
    SPECIES_TO_CORNA(OLD_UNOWN_E),
    SPECIES_TO_CORNA(OLD_UNOWN_F),
    SPECIES_TO_CORNA(OLD_UNOWN_G),
    SPECIES_TO_CORNA(OLD_UNOWN_H),
    SPECIES_TO_CORNA(OLD_UNOWN_I),
    SPECIES_TO_CORNA(OLD_UNOWN_J),
    SPECIES_TO_CORNA(OLD_UNOWN_K),
    SPECIES_TO_CORNA(OLD_UNOWN_L),
    SPECIES_TO_CORNA(OLD_UNOWN_M),
    SPECIES_TO_CORNA(OLD_UNOWN_N),
    SPECIES_TO_CORNA(OLD_UNOWN_O),
    SPECIES_TO_CORNA(OLD_UNOWN_P),
    SPECIES_TO_CORNA(OLD_UNOWN_Q),
    SPECIES_TO_CORNA(OLD_UNOWN_R),
    SPECIES_TO_CORNA(OLD_UNOWN_S),
    SPECIES_TO_CORNA(OLD_UNOWN_T),
    SPECIES_TO_CORNA(OLD_UNOWN_U),
    SPECIES_TO_CORNA(OLD_UNOWN_V),
    SPECIES_TO_CORNA(OLD_UNOWN_W),
    SPECIES_TO_CORNA(OLD_UNOWN_X),
    SPECIES_TO_CORNA(OLD_UNOWN_Y),
    SPECIES_TO_CORNA(OLD_UNOWN_Z),
    SPECIES_TO_CORNA(TREECKO),
    SPECIES_TO_CORNA(GROVYLE),
    SPECIES_TO_CORNA(SCEPTILE),
    SPECIES_TO_CORNA(TORCHIC),
    SPECIES_TO_CORNA(COMBUSKEN),
    SPECIES_TO_CORNA(BLAZIKEN),
    SPECIES_TO_CORNA(MUDKIP),
    SPECIES_TO_CORNA(MARSHTOMP),
    SPECIES_TO_CORNA(SWAMPERT),
    SPECIES_TO_CORNA(POOCHYENA),
    SPECIES_TO_CORNA(MIGHTYENA),
    SPECIES_TO_CORNA(ZIGZAGOON),
    SPECIES_TO_CORNA(LINOONE),
    SPECIES_TO_CORNA(WURMPLE),
    SPECIES_TO_CORNA(SILCOON),
    SPECIES_TO_CORNA(BEAUTIFLY),
    SPECIES_TO_CORNA(CASCOON),
    SPECIES_TO_CORNA(DUSTOX),
    SPECIES_TO_CORNA(LOTAD),
    SPECIES_TO_CORNA(LOMBRE),
    SPECIES_TO_CORNA(LUDICOLO),
    SPECIES_TO_CORNA(SEEDOT),
    SPECIES_TO_CORNA(NUZLEAF),
    SPECIES_TO_CORNA(SHIFTRY),
    SPECIES_TO_CORNA(NINCADA),
    SPECIES_TO_CORNA(NINJASK),
    SPECIES_TO_CORNA(SHEDINJA),
    SPECIES_TO_CORNA(TAILLOW),
    SPECIES_TO_CORNA(SWELLOW),
    SPECIES_TO_CORNA(SHROOMISH),
    SPECIES_TO_CORNA(BRELOOM),
    SPECIES_TO_CORNA(SPINDA),
    SPECIES_TO_CORNA(WINGULL),
    SPECIES_TO_CORNA(PELIPPER),
    SPECIES_TO_CORNA(SURSKIT),
    SPECIES_TO_CORNA(MASQUERAIN),
    SPECIES_TO_CORNA(WAILMER),
    SPECIES_TO_CORNA(WAILORD),
    SPECIES_TO_CORNA(SKITTY),
    SPECIES_TO_CORNA(DELCATTY),
    SPECIES_TO_CORNA(KECLEON),
    SPECIES_TO_CORNA(BALTOY),
    SPECIES_TO_CORNA(CLAYDOL),
    SPECIES_TO_CORNA(NOSEPASS),
    SPECIES_TO_CORNA(TORKOAL),
    SPECIES_TO_CORNA(SABLEYE),
    SPECIES_TO_CORNA(BARBOACH),
    SPECIES_TO_CORNA(WHISCASH),
    SPECIES_TO_CORNA(LUVDISC),
    SPECIES_TO_CORNA(CORPHISH),
    SPECIES_TO_CORNA(CRAWDAUNT),
    SPECIES_TO_CORNA(FEEBAS),
    SPECIES_TO_CORNA(MILOTIC),
    SPECIES_TO_CORNA(CARVANHA),
    SPECIES_TO_CORNA(SHARPEDO),
    SPECIES_TO_CORNA(TRAPINCH),
    SPECIES_TO_CORNA(VIBRAVA),
    SPECIES_TO_CORNA(FLYGON),
    SPECIES_TO_CORNA(MAKUHITA),
    SPECIES_TO_CORNA(HARIYAMA),
    SPECIES_TO_CORNA(ELECTRIKE),
    SPECIES_TO_CORNA(MANECTRIC),
    SPECIES_TO_CORNA(NUMEL),
    SPECIES_TO_CORNA(CAMERUPT),
    SPECIES_TO_CORNA(SPHEAL),
    SPECIES_TO_CORNA(SEALEO),
    SPECIES_TO_CORNA(WALREIN),
    SPECIES_TO_CORNA(CACNEA),
    SPECIES_TO_CORNA(CACTURNE),
    SPECIES_TO_CORNA(SNORUNT),
    SPECIES_TO_CORNA(GLALIE),
    SPECIES_TO_CORNA(LUNATONE),
    SPECIES_TO_CORNA(SOLROCK),
    SPECIES_TO_CORNA(AZURILL),
    SPECIES_TO_CORNA(SPOINK),
    SPECIES_TO_CORNA(GRUMPIG),
    SPECIES_TO_CORNA(PLUSLE),
    SPECIES_TO_CORNA(MINUN),
    SPECIES_TO_CORNA(MAWILE),
    SPECIES_TO_CORNA(MEDITITE),
    SPECIES_TO_CORNA(MEDICHAM),
    SPECIES_TO_CORNA(SWABLU),
    SPECIES_TO_CORNA(ALTARIA),
    SPECIES_TO_CORNA(WYNAUT),
    SPECIES_TO_CORNA(DUSKULL),
    SPECIES_TO_CORNA(DUSCLOPS),
    SPECIES_TO_CORNA(ROSELIA),
    SPECIES_TO_CORNA(SLAKOTH),
    SPECIES_TO_CORNA(VIGOROTH),
    SPECIES_TO_CORNA(SLAKING),
    SPECIES_TO_CORNA(GULPIN),
    SPECIES_TO_CORNA(SWALOT),
    SPECIES_TO_CORNA(TROPIUS),
    SPECIES_TO_CORNA(WHISMUR),
    SPECIES_TO_CORNA(LOUDRED),
    SPECIES_TO_CORNA(EXPLOUD),
    SPECIES_TO_CORNA(CLAMPERL),
    SPECIES_TO_CORNA(HUNTAIL),
    SPECIES_TO_CORNA(GOREBYSS),
    SPECIES_TO_CORNA(ABSOL),
    SPECIES_TO_CORNA(SHUPPET),
    SPECIES_TO_CORNA(BANETTE),
    SPECIES_TO_CORNA(SEVIPER),
    SPECIES_TO_CORNA(ZANGOOSE),
    SPECIES_TO_CORNA(RELICANTH),
    SPECIES_TO_CORNA(ARON),
    SPECIES_TO_CORNA(LAIRON),
    SPECIES_TO_CORNA(AGGRON),
    SPECIES_TO_CORNA(CASTFORM),
    SPECIES_TO_CORNA(VOLBEAT),
    SPECIES_TO_CORNA(ILLUMISE),
    SPECIES_TO_CORNA(LILEEP),
    SPECIES_TO_CORNA(CRADILY),
    SPECIES_TO_CORNA(ANORITH),
    SPECIES_TO_CORNA(ARMALDO),
    SPECIES_TO_CORNA(RALTS),
    SPECIES_TO_CORNA(KIRLIA),
    SPECIES_TO_CORNA(GARDEVOIR),
    SPECIES_TO_CORNA(BAGON),
    SPECIES_TO_CORNA(SHELGON),
    SPECIES_TO_CORNA(SALAMENCE),
    SPECIES_TO_CORNA(BELDUM),
    SPECIES_TO_CORNA(METANG),
    SPECIES_TO_CORNA(METAGROSS),
    SPECIES_TO_CORNA(REGIROCK),
    SPECIES_TO_CORNA(REGICE),
    SPECIES_TO_CORNA(REGISTEEL),
    SPECIES_TO_CORNA(KYOGRE),
    SPECIES_TO_CORNA(GROUDON),
    SPECIES_TO_CORNA(RAYQUAZA),
    SPECIES_TO_CORNA(LATIAS),
    SPECIES_TO_CORNA(LATIOS),
    SPECIES_TO_CORNA(JIRACHI),
    SPECIES_TO_CORNA(DEOXYS),
    SPECIES_TO_CORNA(CHIMECHO),
};
...
const u16 gCornaToNationalOrder[] = // Assigns Corna Dex Pokémon (Using National Dex Index)
{
    CORNA_TO_NATIONAL(TREECKO),
    CORNA_TO_NATIONAL(GROVYLE),
    CORNA_TO_NATIONAL(SCEPTILE),
    CORNA_TO_NATIONAL(TORCHIC),
    CORNA_TO_NATIONAL(COMBUSKEN),
    CORNA_TO_NATIONAL(BLAZIKEN),
    CORNA_TO_NATIONAL(MUDKIP),
    CORNA_TO_NATIONAL(MARSHTOMP),
    CORNA_TO_NATIONAL(SWAMPERT),
    CORNA_TO_NATIONAL(POOCHYENA),
    CORNA_TO_NATIONAL(MIGHTYENA),
    CORNA_TO_NATIONAL(ZIGZAGOON),
    CORNA_TO_NATIONAL(LINOONE),
    CORNA_TO_NATIONAL(WURMPLE),
    CORNA_TO_NATIONAL(SILCOON),
    CORNA_TO_NATIONAL(BEAUTIFLY),
    CORNA_TO_NATIONAL(CASCOON),
    CORNA_TO_NATIONAL(DUSTOX),
    CORNA_TO_NATIONAL(LOTAD),
    CORNA_TO_NATIONAL(LOMBRE),
    CORNA_TO_NATIONAL(LUDICOLO),
    CORNA_TO_NATIONAL(SEEDOT),
    CORNA_TO_NATIONAL(NUZLEAF),
    CORNA_TO_NATIONAL(SHIFTRY),
    CORNA_TO_NATIONAL(TAILLOW),
    CORNA_TO_NATIONAL(SWELLOW),
    CORNA_TO_NATIONAL(WINGULL),
    CORNA_TO_NATIONAL(PELIPPER),
    CORNA_TO_NATIONAL(RALTS),
    CORNA_TO_NATIONAL(KIRLIA),
    CORNA_TO_NATIONAL(GARDEVOIR),
    CORNA_TO_NATIONAL(SURSKIT),
    CORNA_TO_NATIONAL(MASQUERAIN),
    CORNA_TO_NATIONAL(SHROOMISH),
    CORNA_TO_NATIONAL(BRELOOM),
    CORNA_TO_NATIONAL(SLAKOTH),
    CORNA_TO_NATIONAL(VIGOROTH),
    CORNA_TO_NATIONAL(SLAKING),
    CORNA_TO_NATIONAL(ABRA),
    CORNA_TO_NATIONAL(KADABRA),
    CORNA_TO_NATIONAL(ALAKAZAM),
    CORNA_TO_NATIONAL(NINCADA),
    CORNA_TO_NATIONAL(NINJASK),
    CORNA_TO_NATIONAL(SHEDINJA),
    CORNA_TO_NATIONAL(WHISMUR),
    CORNA_TO_NATIONAL(LOUDRED),
    CORNA_TO_NATIONAL(EXPLOUD),
    CORNA_TO_NATIONAL(MAKUHITA),
    CORNA_TO_NATIONAL(HARIYAMA),
    CORNA_TO_NATIONAL(GOLDEEN),
    CORNA_TO_NATIONAL(SEAKING),
    CORNA_TO_NATIONAL(MAGIKARP),
    CORNA_TO_NATIONAL(GYARADOS),
    CORNA_TO_NATIONAL(AZURILL),
    CORNA_TO_NATIONAL(MARILL),
    CORNA_TO_NATIONAL(AZUMARILL),
    CORNA_TO_NATIONAL(GEODUDE),
    CORNA_TO_NATIONAL(GRAVELER),
    CORNA_TO_NATIONAL(GOLEM),
    CORNA_TO_NATIONAL(NOSEPASS),
    CORNA_TO_NATIONAL(SKITTY),
    CORNA_TO_NATIONAL(DELCATTY),
    CORNA_TO_NATIONAL(ZUBAT),
    CORNA_TO_NATIONAL(GOLBAT),
    CORNA_TO_NATIONAL(CROBAT),
    CORNA_TO_NATIONAL(TENTACOOL),
    CORNA_TO_NATIONAL(TENTACRUEL),
    CORNA_TO_NATIONAL(SABLEYE),
    CORNA_TO_NATIONAL(MAWILE),
    CORNA_TO_NATIONAL(ARON),
    CORNA_TO_NATIONAL(LAIRON),
    CORNA_TO_NATIONAL(AGGRON),
    CORNA_TO_NATIONAL(MACHOP),
    CORNA_TO_NATIONAL(MACHOKE),
    CORNA_TO_NATIONAL(MACHAMP),
    CORNA_TO_NATIONAL(MEDITITE),
    CORNA_TO_NATIONAL(MEDICHAM),
    CORNA_TO_NATIONAL(ELECTRIKE),
    CORNA_TO_NATIONAL(MANECTRIC),
    CORNA_TO_NATIONAL(PLUSLE),
    CORNA_TO_NATIONAL(MINUN),
    CORNA_TO_NATIONAL(MAGNEMITE),
    CORNA_TO_NATIONAL(MAGNETON),
    CORNA_TO_NATIONAL(VOLTORB),
    CORNA_TO_NATIONAL(ELECTRODE),
    CORNA_TO_NATIONAL(VOLBEAT),
    CORNA_TO_NATIONAL(ILLUMISE),
    CORNA_TO_NATIONAL(ODDISH),
    CORNA_TO_NATIONAL(GLOOM),
    CORNA_TO_NATIONAL(VILEPLUME),
    CORNA_TO_NATIONAL(BELLOSSOM),
    CORNA_TO_NATIONAL(DODUO),
    CORNA_TO_NATIONAL(DODRIO),
    CORNA_TO_NATIONAL(ROSELIA),
    CORNA_TO_NATIONAL(GULPIN),
    CORNA_TO_NATIONAL(SWALOT),
    CORNA_TO_NATIONAL(CARVANHA),
    CORNA_TO_NATIONAL(SHARPEDO),
    CORNA_TO_NATIONAL(WAILMER),
    CORNA_TO_NATIONAL(WAILORD),
    CORNA_TO_NATIONAL(NUMEL),
    CORNA_TO_NATIONAL(CAMERUPT),
    CORNA_TO_NATIONAL(SLUGMA),
    CORNA_TO_NATIONAL(MAGCARGO),
    CORNA_TO_NATIONAL(TORKOAL),
    CORNA_TO_NATIONAL(GRIMER),
    CORNA_TO_NATIONAL(MUK),
    CORNA_TO_NATIONAL(KOFFING),
    CORNA_TO_NATIONAL(WEEZING),
    CORNA_TO_NATIONAL(SPOINK),
    CORNA_TO_NATIONAL(GRUMPIG),
    CORNA_TO_NATIONAL(SANDSHREW),
    CORNA_TO_NATIONAL(SANDSLASH),
    CORNA_TO_NATIONAL(SPINDA),
    CORNA_TO_NATIONAL(SKARMORY),
    CORNA_TO_NATIONAL(TRAPINCH),
    CORNA_TO_NATIONAL(VIBRAVA),
    CORNA_TO_NATIONAL(FLYGON),
    CORNA_TO_NATIONAL(CACNEA),
    CORNA_TO_NATIONAL(CACTURNE),
    CORNA_TO_NATIONAL(SWABLU),
    CORNA_TO_NATIONAL(ALTARIA),
    CORNA_TO_NATIONAL(ZANGOOSE),
    CORNA_TO_NATIONAL(SEVIPER),
    CORNA_TO_NATIONAL(LUNATONE),
    CORNA_TO_NATIONAL(SOLROCK),
    CORNA_TO_NATIONAL(BARBOACH),
    CORNA_TO_NATIONAL(WHISCASH),
    CORNA_TO_NATIONAL(CORPHISH),
    CORNA_TO_NATIONAL(CRAWDAUNT),
    CORNA_TO_NATIONAL(BALTOY),
    CORNA_TO_NATIONAL(CLAYDOL),
    CORNA_TO_NATIONAL(LILEEP),
    CORNA_TO_NATIONAL(CRADILY),
    CORNA_TO_NATIONAL(ANORITH),
    CORNA_TO_NATIONAL(ARMALDO),
    CORNA_TO_NATIONAL(IGGLYBUFF),
    CORNA_TO_NATIONAL(JIGGLYPUFF),
    CORNA_TO_NATIONAL(WIGGLYTUFF),
    CORNA_TO_NATIONAL(FEEBAS),
    CORNA_TO_NATIONAL(MILOTIC),
    CORNA_TO_NATIONAL(CASTFORM),
    CORNA_TO_NATIONAL(STARYU),
    CORNA_TO_NATIONAL(STARMIE),
    CORNA_TO_NATIONAL(KECLEON),
    CORNA_TO_NATIONAL(SHUPPET),
    CORNA_TO_NATIONAL(BANETTE),
    CORNA_TO_NATIONAL(DUSKULL),
    CORNA_TO_NATIONAL(DUSCLOPS),
    CORNA_TO_NATIONAL(TROPIUS),
    CORNA_TO_NATIONAL(CHIMECHO),
    CORNA_TO_NATIONAL(ABSOL),
    CORNA_TO_NATIONAL(VULPIX),
    CORNA_TO_NATIONAL(NINETALES),
    CORNA_TO_NATIONAL(PICHU),
    CORNA_TO_NATIONAL(PIKACHU),
    CORNA_TO_NATIONAL(RAICHU),
    CORNA_TO_NATIONAL(PSYDUCK),
    CORNA_TO_NATIONAL(GOLDUCK),
    CORNA_TO_NATIONAL(WYNAUT),
    CORNA_TO_NATIONAL(WOBBUFFET),
    CORNA_TO_NATIONAL(NATU),
    CORNA_TO_NATIONAL(XATU),
    CORNA_TO_NATIONAL(GIRAFARIG),
    CORNA_TO_NATIONAL(PHANPY),
    CORNA_TO_NATIONAL(DONPHAN),
    CORNA_TO_NATIONAL(PINSIR),
    CORNA_TO_NATIONAL(HERACROSS),
    CORNA_TO_NATIONAL(RHYHORN),
    CORNA_TO_NATIONAL(RHYDON),
    CORNA_TO_NATIONAL(SNORUNT),
    CORNA_TO_NATIONAL(GLALIE),
    CORNA_TO_NATIONAL(SPHEAL),
    CORNA_TO_NATIONAL(SEALEO),
    CORNA_TO_NATIONAL(WALREIN),
    CORNA_TO_NATIONAL(CLAMPERL),
    CORNA_TO_NATIONAL(HUNTAIL),
    CORNA_TO_NATIONAL(GOREBYSS),
    CORNA_TO_NATIONAL(RELICANTH),
    CORNA_TO_NATIONAL(CORSOLA),
    CORNA_TO_NATIONAL(CHINCHOU),
    CORNA_TO_NATIONAL(LANTURN),
    CORNA_TO_NATIONAL(LUVDISC),
    CORNA_TO_NATIONAL(HORSEA),
    CORNA_TO_NATIONAL(SEADRA),
    CORNA_TO_NATIONAL(KINGDRA),
    CORNA_TO_NATIONAL(BAGON),
    CORNA_TO_NATIONAL(SHELGON),
    CORNA_TO_NATIONAL(SALAMENCE),
    CORNA_TO_NATIONAL(BELDUM),
    CORNA_TO_NATIONAL(METANG),
    CORNA_TO_NATIONAL(METAGROSS),
    CORNA_TO_NATIONAL(REGIROCK),
    CORNA_TO_NATIONAL(REGICE),
    CORNA_TO_NATIONAL(REGISTEEL),
    CORNA_TO_NATIONAL(LATIAS),
    CORNA_TO_NATIONAL(LATIOS),
    CORNA_TO_NATIONAL(KYOGRE),
    CORNA_TO_NATIONAL(GROUDON),
    CORNA_TO_NATIONAL(RAYQUAZA),
    CORNA_TO_NATIONAL(JIRACHI),
    CORNA_TO_NATIONAL(DEOXYS),
    CORNA_TO_NATIONAL(BULBASAUR), // Pokémon from here onwards are UNSEEN in the CornaDex.
    CORNA_TO_NATIONAL(IVYSAUR),
    CORNA_TO_NATIONAL(VENUSAUR),
    CORNA_TO_NATIONAL(CHARMANDER),
    CORNA_TO_NATIONAL(CHARMELEON),
    CORNA_TO_NATIONAL(CHARIZARD),
    CORNA_TO_NATIONAL(SQUIRTLE),
    CORNA_TO_NATIONAL(WARTORTLE),
    CORNA_TO_NATIONAL(BLASTOISE),
    CORNA_TO_NATIONAL(CATERPIE),
    CORNA_TO_NATIONAL(METAPOD),
    CORNA_TO_NATIONAL(BUTTERFREE),
    CORNA_TO_NATIONAL(WEEDLE),
    CORNA_TO_NATIONAL(KAKUNA),
    CORNA_TO_NATIONAL(BEEDRILL),
    CORNA_TO_NATIONAL(PIDGEY),
    CORNA_TO_NATIONAL(PIDGEOTTO),
    CORNA_TO_NATIONAL(PIDGEOT),
    CORNA_TO_NATIONAL(RATTATA),
    CORNA_TO_NATIONAL(RATICATE),
    CORNA_TO_NATIONAL(SPEAROW),
    CORNA_TO_NATIONAL(FEAROW),
    CORNA_TO_NATIONAL(EKANS),
    CORNA_TO_NATIONAL(ARBOK),
    CORNA_TO_NATIONAL(NIDORAN_F),
    CORNA_TO_NATIONAL(NIDORINA),
    CORNA_TO_NATIONAL(NIDOQUEEN),
    CORNA_TO_NATIONAL(NIDORAN_M),
    CORNA_TO_NATIONAL(NIDORINO),
    CORNA_TO_NATIONAL(NIDOKING),
    CORNA_TO_NATIONAL(CLEFAIRY),
    CORNA_TO_NATIONAL(CLEFABLE),
    CORNA_TO_NATIONAL(PARAS),
    CORNA_TO_NATIONAL(PARASECT),
    CORNA_TO_NATIONAL(VENONAT),
    CORNA_TO_NATIONAL(VENOMOTH),
    CORNA_TO_NATIONAL(DIGLETT),
    CORNA_TO_NATIONAL(DUGTRIO),
    CORNA_TO_NATIONAL(MEOWTH),
    CORNA_TO_NATIONAL(PERSIAN),
    CORNA_TO_NATIONAL(MANKEY),
    CORNA_TO_NATIONAL(PRIMEAPE),
    CORNA_TO_NATIONAL(GROWLITHE),
    CORNA_TO_NATIONAL(ARCANINE),
    CORNA_TO_NATIONAL(POLIWAG),
    CORNA_TO_NATIONAL(POLIWHIRL),
    CORNA_TO_NATIONAL(POLIWRATH),
    CORNA_TO_NATIONAL(BELLSPROUT),
    CORNA_TO_NATIONAL(WEEPINBELL),
    CORNA_TO_NATIONAL(VICTREEBEL),
    CORNA_TO_NATIONAL(PONYTA),
    CORNA_TO_NATIONAL(RAPIDASH),
    CORNA_TO_NATIONAL(SLOWPOKE),
    CORNA_TO_NATIONAL(SLOWBRO),
    CORNA_TO_NATIONAL(FARFETCHD),
    CORNA_TO_NATIONAL(SEEL),
    CORNA_TO_NATIONAL(DEWGONG),
    CORNA_TO_NATIONAL(SHELLDER),
    CORNA_TO_NATIONAL(CLOYSTER),
    CORNA_TO_NATIONAL(GASTLY),
    CORNA_TO_NATIONAL(HAUNTER),
    CORNA_TO_NATIONAL(GENGAR),
    CORNA_TO_NATIONAL(ONIX),
    CORNA_TO_NATIONAL(DROWZEE),
    CORNA_TO_NATIONAL(HYPNO),
    CORNA_TO_NATIONAL(KRABBY),
    CORNA_TO_NATIONAL(KINGLER),
    CORNA_TO_NATIONAL(EXEGGCUTE),
    CORNA_TO_NATIONAL(EXEGGUTOR),
    CORNA_TO_NATIONAL(CUBONE),
    CORNA_TO_NATIONAL(MAROWAK),
    CORNA_TO_NATIONAL(HITMONLEE),
    CORNA_TO_NATIONAL(HITMONCHAN),
    CORNA_TO_NATIONAL(LICKITUNG),
    CORNA_TO_NATIONAL(CHANSEY),
    CORNA_TO_NATIONAL(TANGELA),
    CORNA_TO_NATIONAL(KANGASKHAN),
    CORNA_TO_NATIONAL(MR_MIME),
    CORNA_TO_NATIONAL(SCYTHER),
    CORNA_TO_NATIONAL(JYNX),
    CORNA_TO_NATIONAL(ELECTABUZZ),
    CORNA_TO_NATIONAL(MAGMAR),
    CORNA_TO_NATIONAL(TAUROS),
    CORNA_TO_NATIONAL(LAPRAS),
    CORNA_TO_NATIONAL(DITTO),
    CORNA_TO_NATIONAL(EEVEE),
    CORNA_TO_NATIONAL(VAPOREON),
    CORNA_TO_NATIONAL(JOLTEON),
    CORNA_TO_NATIONAL(FLAREON),
    CORNA_TO_NATIONAL(PORYGON),
    CORNA_TO_NATIONAL(OMANYTE),
    CORNA_TO_NATIONAL(OMASTAR),
    CORNA_TO_NATIONAL(KABUTO),
    CORNA_TO_NATIONAL(KABUTOPS),
    CORNA_TO_NATIONAL(AERODACTYL),
    CORNA_TO_NATIONAL(SNORLAX),
    CORNA_TO_NATIONAL(ARTICUNO),
    CORNA_TO_NATIONAL(ZAPDOS),
    CORNA_TO_NATIONAL(MOLTRES),
    CORNA_TO_NATIONAL(DRATINI),
    CORNA_TO_NATIONAL(DRAGONAIR),
    CORNA_TO_NATIONAL(DRAGONITE),
    CORNA_TO_NATIONAL(MEWTWO),
    CORNA_TO_NATIONAL(MEW),
    CORNA_TO_NATIONAL(CHIKORITA),
    CORNA_TO_NATIONAL(BAYLEEF),
    CORNA_TO_NATIONAL(MEGANIUM),
    CORNA_TO_NATIONAL(CYNDAQUIL),
    CORNA_TO_NATIONAL(QUILAVA),
    CORNA_TO_NATIONAL(TYPHLOSION),
    CORNA_TO_NATIONAL(TOTODILE),
    CORNA_TO_NATIONAL(CROCONAW),
    CORNA_TO_NATIONAL(FERALIGATR),
    CORNA_TO_NATIONAL(SENTRET),
    CORNA_TO_NATIONAL(FURRET),
    CORNA_TO_NATIONAL(HOOTHOOT),
    CORNA_TO_NATIONAL(NOCTOWL),
    CORNA_TO_NATIONAL(LEDYBA),
    CORNA_TO_NATIONAL(LEDIAN),
    CORNA_TO_NATIONAL(SPINARAK),
    CORNA_TO_NATIONAL(ARIADOS),
    CORNA_TO_NATIONAL(CLEFFA),
    CORNA_TO_NATIONAL(TOGEPI),
    CORNA_TO_NATIONAL(TOGETIC),
    CORNA_TO_NATIONAL(MAREEP),
    CORNA_TO_NATIONAL(FLAAFFY),
    CORNA_TO_NATIONAL(AMPHAROS),
    CORNA_TO_NATIONAL(SUDOWOODO),
    CORNA_TO_NATIONAL(POLITOED),
    CORNA_TO_NATIONAL(HOPPIP),
    CORNA_TO_NATIONAL(SKIPLOOM),
    CORNA_TO_NATIONAL(JUMPLUFF),
    CORNA_TO_NATIONAL(AIPOM),
    CORNA_TO_NATIONAL(SUNKERN),
    CORNA_TO_NATIONAL(SUNFLORA),
    CORNA_TO_NATIONAL(YANMA),
    CORNA_TO_NATIONAL(WOOPER),
    CORNA_TO_NATIONAL(QUAGSIRE),
    CORNA_TO_NATIONAL(ESPEON),
    CORNA_TO_NATIONAL(UMBREON),
    CORNA_TO_NATIONAL(MURKROW),
    CORNA_TO_NATIONAL(SLOWKING),
    CORNA_TO_NATIONAL(MISDREAVUS),
    CORNA_TO_NATIONAL(UNOWN),
    CORNA_TO_NATIONAL(PINECO),
    CORNA_TO_NATIONAL(FORRETRESS),
    CORNA_TO_NATIONAL(DUNSPARCE),
    CORNA_TO_NATIONAL(GLIGAR),
    CORNA_TO_NATIONAL(STEELIX),
    CORNA_TO_NATIONAL(SNUBBULL),
    CORNA_TO_NATIONAL(GRANBULL),
    CORNA_TO_NATIONAL(QWILFISH),
    CORNA_TO_NATIONAL(SCIZOR),
    CORNA_TO_NATIONAL(SHUCKLE),
    CORNA_TO_NATIONAL(SNEASEL),
    CORNA_TO_NATIONAL(TEDDIURSA),
    CORNA_TO_NATIONAL(URSARING),
    CORNA_TO_NATIONAL(SWINUB),
    CORNA_TO_NATIONAL(PILOSWINE),
    CORNA_TO_NATIONAL(REMORAID),
    CORNA_TO_NATIONAL(OCTILLERY),
    CORNA_TO_NATIONAL(DELIBIRD),
    CORNA_TO_NATIONAL(MANTINE),
    CORNA_TO_NATIONAL(HOUNDOUR),
    CORNA_TO_NATIONAL(HOUNDOOM),
    CORNA_TO_NATIONAL(PORYGON2),
    CORNA_TO_NATIONAL(STANTLER),
    CORNA_TO_NATIONAL(SMEARGLE),
    CORNA_TO_NATIONAL(TYROGUE),
    CORNA_TO_NATIONAL(HITMONTOP),
    CORNA_TO_NATIONAL(SMOOCHUM),
    CORNA_TO_NATIONAL(ELEKID),
    CORNA_TO_NATIONAL(MAGBY),
    CORNA_TO_NATIONAL(MILTANK),
    CORNA_TO_NATIONAL(BLISSEY),
    CORNA_TO_NATIONAL(RAIKOU),
    CORNA_TO_NATIONAL(ENTEI),
    CORNA_TO_NATIONAL(SUICUNE),
    CORNA_TO_NATIONAL(LARVITAR),
    CORNA_TO_NATIONAL(PUPITAR),
    CORNA_TO_NATIONAL(TYRANITAR),
    CORNA_TO_NATIONAL(LUGIA),
    CORNA_TO_NATIONAL(HO_OH),
    CORNA_TO_NATIONAL(CELEBI),
    CORNA_TO_NATIONAL(OLD_UNOWN_B),
    CORNA_TO_NATIONAL(OLD_UNOWN_C),
    CORNA_TO_NATIONAL(OLD_UNOWN_D),
    CORNA_TO_NATIONAL(OLD_UNOWN_E),
    CORNA_TO_NATIONAL(OLD_UNOWN_F),
    CORNA_TO_NATIONAL(OLD_UNOWN_G),
    CORNA_TO_NATIONAL(OLD_UNOWN_H),
    CORNA_TO_NATIONAL(OLD_UNOWN_I),
    CORNA_TO_NATIONAL(OLD_UNOWN_J),
    CORNA_TO_NATIONAL(OLD_UNOWN_K),
    CORNA_TO_NATIONAL(OLD_UNOWN_L),
    CORNA_TO_NATIONAL(OLD_UNOWN_M),
    CORNA_TO_NATIONAL(OLD_UNOWN_N),
    CORNA_TO_NATIONAL(OLD_UNOWN_O),
    CORNA_TO_NATIONAL(OLD_UNOWN_P),
    CORNA_TO_NATIONAL(OLD_UNOWN_Q),
    CORNA_TO_NATIONAL(OLD_UNOWN_R),
    CORNA_TO_NATIONAL(OLD_UNOWN_S),
    CORNA_TO_NATIONAL(OLD_UNOWN_T),
    CORNA_TO_NATIONAL(OLD_UNOWN_U),
    CORNA_TO_NATIONAL(OLD_UNOWN_V),
    CORNA_TO_NATIONAL(OLD_UNOWN_W),
    CORNA_TO_NATIONAL(OLD_UNOWN_X),
    CORNA_TO_NATIONAL(OLD_UNOWN_Y),
    CORNA_TO_NATIONAL(OLD_UNOWN_Z),
};
...
static const struct SpriteTemplate sTrainerBackSpriteTemplates[] =
{
    ...
    [TRAINER_BACK_PIC_RUBY_SAPPHIRE_AKIRA] = {
        .tileTag = 0xFFFF,
        .paletteTag = 0,
        .oam = &gOamData_BattleSpritePlayerSide,
        .anims = NULL,
...
u16 CornaPokedexNumToSpecies(u16 cornaNum)
{
    ...
    while (species < (NUM_SPECIES - 1) && gSpeciesToCornaPokedexNum[species] != cornaNum)
        species++;
...
u16 NationalToCornaOrder(u16 nationalNum)
{
    ...
    while (cornaNum < (NUM_SPECIES - 1) && gCornaToNationalOrder[cornaNum] != nationalNum)
        cornaNum++;

    if (cornaNum == NUM_SPECIES - 1)
        return 0;
...
u16 SpeciesToCornaPokedexNum(u16 species)
{
    ...
    return gSpeciesToCornaPokedexNum[species - 1];
}
...
u16 CornaToNationalOrder(u16 cornaNum)
{
    ...
    return gCornaToNationalOrder[cornaNum - 1];
}
...
u16 SpeciesToPokedexNum(u16 species)
{
    ...
    {
        species = SpeciesToCornaPokedexNum(species);
        if (species <= CORNA_DEX_COUNT)
            return species;
        return 0xFFFF;
    }
}
...
{
    if (SpeciesToCornaPokedexNum(species) > CORNA_DEX_COUNT)
        return FALSE;
    else
        return TRUE;
}
