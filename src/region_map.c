...
static const u16 sRegionMapPlayerIcon_AkiraPal[] = INCBIN_U16("graphics/pokenav/akira_icon.gbapal");
static const u8 sRegionMapPlayerIcon_AkiraGfx[] = INCBIN_U8("graphics/pokenav/akira_icon.4bpp");
...
{
    {MAPSEC_UNDERWATER_105,             MAPSEC_BROKE_SEA},
    ...
    {MAPSEC_DARKNESS_FOREST,            MAPSEC_CLOUD_BEACH},
    {MAPSEC_JAGGED_PASS,                MAPSEC_ROUTE_112},
    {MAPSEC_MT_PYRE,                    MAPSEC_ROUTE_122},
    {MAPSEC_SKY_PILLAR,                 MAPSEC_ROUTE_131},
    {MAPSEC_MIRAGE_TOWER,               MAPSEC_BROWN_HILL},
    {MAPSEC_TRAINER_HILL,               MAPSEC_BROWN_HILL},
    {MAPSEC_DESERT_UNDERPASS,           MAPSEC_ROUTE_114},
    {MAPSEC_ALTERING_CAVE,              MAPSEC_ROCK_CANYON},
    {MAPSEC_ARTISAN_CAVE,               MAPSEC_ROCK_CANYON},
...
static const u16 sTerraOrMarineCaveMapSecIds[ABNORMAL_WEATHER_LOCATIONS] =
{
    ...
    [ABNORMAL_WEATHER_BROKE_SEA_NORTH - 1] = MAPSEC_BROKE_SEA,
    [ABNORMAL_WEATHER_BROKE_SEA_SOUTH - 1] = MAPSEC_BROKE_SEA,
...
{
    [MARINE_CAVE_COORD(BROKE_SEA_NORTH)] = {0, 10},
    [MARINE_CAVE_COORD(BROKE_SEA_SOUTH)] = {0, 12},
...
{
    {MAP_GROUP(BREEZE_TOWN), MAP_NUM(BREEZE_TOWN), HEAL_LOCATION_BREEZE_TOWN_AKIRAS_HOUSE_2F},
    {MAP_GROUP(PINK_TOWN), MAP_NUM(PINK_TOWN), HEAL_LOCATION_PINK_TOWN},
    {MAP_GROUP(GOLDEN_ISLAND), MAP_NUM(GOLDEN_ISLAND), HEAL_LOCATION_GOLDEN_ISLAND},
    ...
    {MAP_GROUP(CLOUDAIN_CITY), MAP_NUM(CLOUDAIN_CITY), HEAL_LOCATION_CLOUDAIN_CITY},
    ...
    {MAP_GROUP(BREEZE_WAY), MAP_NUM(BREEZE_WAY), 0},
    {MAP_GROUP(CLOUD_WAY), MAP_NUM(CLOUD_WAY), 0},
    {MAP_GROUP(ROCK_CANYON), MAP_NUM(ROCK_CANYON), 0},
    {MAP_GROUP(CLOUD_BEACH), MAP_NUM(CLOUD_BEACH), 0},
    {MAP_GROUP(BROKE_SEA), MAP_NUM(BROKE_SEA), 0},
    ...
    {MAP_GROUP(BROWN_HILL), MAP_NUM(BROWN_HILL), 0},
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_BREEZE_TOWN:
        return FlagGet(FLAG_VISITED_BREEZE_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_PINK_TOWN:
        return FlagGet(FLAG_VISITED_PINK_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_GOLDEN_ISLAND:
        return FlagGet(FLAG_VISITED_GOLDEN_ISLAND) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    ...
    case MAPSEC_CLOUDAIN_CITY:
        return FlagGet(FLAG_VISITED_CLOUDAIN_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
{
    u8 spriteId;
    struct SpriteSheet sheet = {sRegionMapPlayerIcon_AkiraGfx, 0x80, tileTag};
    struct SpritePalette palette = {sRegionMapPlayerIcon_AkiraPal, paletteTag};
...
static void CreateFlyDestIcons(void)
{
    ...
    canFlyFlag = FLAG_VISITED_BREEZE_TOWN;
    for (mapSecId = MAPSEC_BREEZE_TOWN; mapSecId <= MAPSEC_EVER_GRANDE_CITY; mapSecId++)
    {
        ...
        if (!UpdatePaletteFade())
        {
            ...
            if (sFlyMap->choseFlyLocation)
            {
                ...
                case MAPSEC_BATTLE_FRONTIER:
                    ...
                    break;
                case MAPSEC_BREEZE_TOWN:
                    SetWarpDestinationToHealLocation(gSaveBlock2Ptr->playerGender == MALE ? HEAL_LOCATION_BREEZE_TOWN_AKIRAS_HOUSE : HEAL_LOCATION_BREEZE_TOWN_MAYS_HOUSE);
                    break;
                case MAPSEC_EVER_GRANDE_CITY:
