...
static const u8 sMapHealLocations[][3] =
{
    ...
    {MAP_GROUP(MAROON_TOWN), MAP_NUM(MAROON_TOWN), HEAL_LOCATION_MAROON_TOWN},
    ...
    {MAP_GROUP(BREEZEWAY), MAP_NUM(BREEZEWAY), 0},
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_MAROON_TOWN:
        return FlagGet(FLAG_VISITED_MAROON_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
