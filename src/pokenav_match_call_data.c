...
typedef union {
    ...
    const struct MatchCallBaro *baro;
...
static bool32 MatchCall_GetEnabled_Baro(match_call_t);
...
static u8 MatchCall_GetMapSec_Baro(match_call_t);
...
static bool32 MatchCall_IsRematchable_Baro(match_call_t);
...
static bool32 MatchCall_HasCheckPage_Baro(match_call_t);
...
static u32 MatchCall_GetRematchTableIdx_Baro(match_call_t);
...
static void MatchCall_GetMessage_Baro(match_call_t, u8 *);
...
static void MatchCall_GetNameAndDesc_Baro(match_call_t, const u8 **, const u8 **);
...
static const match_call_text_data_t sMrStoneTextScripts[] = {
    ...
    { MatchCall_Text_MrStone6,  FLAG_DEFEATED_CLOUDAIN_GYM,         0xFFFF },
...
static const match_call_text_data_t sNormanTextScripts[] = {
    ...
    { MatchCall_Text_Norman4, FLAG_DEFEATED_CLOUDAIN_GYM,   0xFFFF },
...
static const struct MatchCallBaro sProfBaroMatchCallHeader =
{
    .type = MC_TYPE_BARO,
    .mapSec = 0,
    .flag = FLAG_ENABLE_PROF_BARO_MATCH_CALL,
    .desc = gText_ProfBaroMatchCallDesc,
    .name = gText_ProfBaroMatchCallName
};

static const match_call_text_data_t sMomTextScripts[] = {
    { MatchCall_Text_Mom1, 0xFFFF,                      0xFFFF },
    { MatchCall_Text_Mom2, FLAG_DEFEATED_CLOUDAIN_GYM, 0xFFFF },
...
static const match_call_text_data_t sMayTextScripts[] = {
    ...
    { MatchCall_Text_May7,  FLAG_DEFEATED_CLOUDAIN_GYM,         0xFFFF },
...
static const struct MatchCallRival sMayMatchCallHeader =
{
    ...
    .desc = gText_MayAkiraMatchCallDesc,
    .name = gText_ExpandedPlaceholder_May,
    .textData = sMayTextScripts
};

static const match_call_text_data_t sAkiraTextScripts[] = {
    { MatchCall_Text_Akira1,  0xFFFF,                              0xFFFF },
    { MatchCall_Text_Akira2,  FLAG_DEFEATED_DEWFORD_GYM,           0xFFFF },
    { MatchCall_Text_Akira3,  FLAG_DELIVERED_DEVON_GOODS,          0xFFFF },
    { MatchCall_Text_Akira4,  FLAG_HIDE_MAUVILLE_CITY_WALLY,       0xFFFF },
    { MatchCall_Text_Akira5,  FLAG_RECEIVED_HM04,                  0xFFFF },
    { MatchCall_Text_Akira6,  FLAG_DEFEATED_LAVARIDGE_GYM,         0xFFFF },
    { MatchCall_Text_Akira7,  FLAG_DEFEATED_CLOUDAIN_GYM,         0xFFFF },
    { MatchCall_Text_Akira8,  FLAG_RECEIVED_CASTFORM,              0xFFFF },
    { MatchCall_Text_Akira9,  FLAG_RECEIVED_RED_OR_BLUE_ORB,       0xFFFF },
    { MatchCall_Text_Akira10, FLAG_GROUDON_AWAKENED_MAGMA_HIDEOUT, 0xFFFF },
    { MatchCall_Text_Akira11, FLAG_MET_TEAM_AQUA_HARBOR,           0xFFFF },
    { MatchCall_Text_Akira12, FLAG_TEAM_AQUA_ESCAPED_IN_SUBMARINE, 0xFFFF },
    { MatchCall_Text_Akira13, FLAG_KYOGRE_ESCAPED_SEAFLOOR_CAVERN, 0xFFFF },
    { MatchCall_Text_Akira14, FLAG_DEFEATED_SOOTOPOLIS_GYM,        0xFFFF },
    { MatchCall_Text_Akira15, FLAG_SYS_GAME_CLEAR,                 0xFFFF },
    { NULL,                     0xFFFF,                              0xFFFF }
};

static const struct MatchCallRival sAkiraMatchCallHeader =
{
    .type = MC_TYPE_RIVAL,
    .playerGender = FEMALE,
    .flag = FLAG_ENABLE_RIVAL_MATCH_CALL,
    .desc = gText_MayAkiraMatchCallDesc,
    .name = gText_ExpandedPlaceholder_Akira,
    .textData = sAkiraTextScripts
};
...
static const match_call_text_data_t sBettiTextScripts[] = {
    { MatchCall_Text_Betti1, 0xFFFE,              0xFFFF },
    { MatchCall_Text_Betti2, 0xFFFF,              0xFFFF },
    { MatchCall_Text_Betti3, 0xFFFF,              0xFFFF },
    { MatchCall_Text_Betti4, FLAG_SYS_GAME_CLEAR, 0xFFFF },
    { NULL,                    0xFFFF,              0xFFFF }
};

static const struct MatchCallStructTrainer sBettiMatchCallHeader =
{
    .type = MC_TYPE_LEADER,
    .mapSec = MAPSEC_RUSTBORO_CITY,
    .flag = FLAG_ENABLE_BETTI_MATCH_CALL,
    .rematchTableIdx = REMATCH_BETTI,
    .desc = gText_BettiMatchCallDesc,
    .name = NULL,
    .textData = sBettiTextScripts
};
...
static const match_call_t sMatchCallHeaders[] = {
    ...
    [MC_HEADER_PROF_BARO] = {.baro  = &sProfBaroMatchCallHeader},
    [MC_HEADER_AKIRA]    = {.rival  = &sAkiraMatchCallHeader},
    ...
    [MC_HEADER_BETTI]    = {.leader = &sBettiMatchCallHeader},
...
static u32 (*const sMatchCall_GetRematchTableIdxFunctions[])(match_call_t) = {
    ...
    MatchCall_GetRematchTableIdx_Baro
};
...
static const struct MatchCallCheckPageOverride sCheckPageOverrides[] = {
    ...
    {
        .idx = MC_HEADER_AKIRA,
        .facilityClass = FACILITY_CLASS_AKIRA,
        .flag = 0xFFFF,
        .flavorTexts = MCFLAVOR(Akira)
    },
    {
        .idx = MC_HEADER_MAY,
...
static bool32 MatchCall_GetEnabled_Baro(match_call_t matchCall)
{
    return FlagGet(matchCall.baro->flag);
}
...
static u8 MatchCall_GetMapSec_Baro(match_call_t matchCall)
{
    return MAPSEC_NONE;
}
...
static bool32 MatchCall_IsRematchable_Baro(match_call_t matchCall)
{
    return FALSE;
}
...
static bool32 MatchCall_HasCheckPage_Baro(match_call_t matchCall)
{
    return FALSE;
}
...
static u32 MatchCall_GetRematchTableIdx_Baro(match_call_t matchCall)
{
    return REMATCH_TABLE_ENTRIES;
}
...
static void MatchCall_GetMessage_Baro(match_call_t matchCall, u8 *dest)
{
...
static void MatchCall_GetNameAndDesc_Baro(match_call_t matchCall, const u8 **desc, const u8 **name)
{
    *desc = matchCall.baro->desc;
    *name = matchCall.baro->name;
}
