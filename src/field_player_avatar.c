...
{
    {OBJ_EVENT_GFX_RIVAL_AKIRA_NORMAL,     OBJ_EVENT_GFX_RIVAL_RAN_NORMAL},
    {OBJ_EVENT_GFX_RIVAL_AKIRA_MACH_BIKE,  OBJ_EVENT_GFX_RIVAL_RAN_MACH_BIKE},
    {OBJ_EVENT_GFX_RIVAL_AKIRA_ACRO_BIKE,  OBJ_EVENT_GFX_RIVAL_RAN_ACRO_BIKE},
    {OBJ_EVENT_GFX_RIVAL_AKIRA_SURFING,    OBJ_EVENT_GFX_RIVAL_RAN_SURFING},
    {OBJ_EVENT_GFX_AKIRA_UNDERWATER,       OBJ_EVENT_GFX_RAN_UNDERWATER},
    {OBJ_EVENT_GFX_RIVAL_AKIRA_FIELD_MOVE, OBJ_EVENT_GFX_RIVAL_RAN_FIELD_MOVE},
    {OBJ_EVENT_GFX_AKIRA_FISHING,          OBJ_EVENT_GFX_RAN_FISHING},
    {OBJ_EVENT_GFX_AKIRA_WATERING,         OBJ_EVENT_GFX_RAN_WATERING}
};

static const u8 sPlayerAvatarGfxIds[][2] =
{
    {OBJ_EVENT_GFX_AKIRA_NORMAL,     OBJ_EVENT_GFX_RAN_NORMAL},
    {OBJ_EVENT_GFX_AKIRA_MACH_BIKE,  OBJ_EVENT_GFX_RAN_MACH_BIKE},
    {OBJ_EVENT_GFX_AKIRA_ACRO_BIKE,  OBJ_EVENT_GFX_RAN_ACRO_BIKE},
    {OBJ_EVENT_GFX_AKIRA_SURFING,    OBJ_EVENT_GFX_RAN_SURFING},
    {OBJ_EVENT_GFX_AKIRA_UNDERWATER, OBJ_EVENT_GFX_RAN_UNDERWATER},
    {OBJ_EVENT_GFX_AKIRA_FIELD_MOVE, OBJ_EVENT_GFX_RAN_FIELD_MOVE},
    {OBJ_EVENT_GFX_AKIRA_FISHING,    OBJ_EVENT_GFX_RAN_FISHING},
    {OBJ_EVENT_GFX_AKIRA_WATERING,   OBJ_EVENT_GFX_RAN_WATERING},
};
...
static const u8 sRSAvatarGfxIds[] = {OBJ_EVENT_GFX_LINK_RS_AKIRA, OBJ_EVENT_GFX_LINK_RS_RAN};

static const u8 sPlayerAvatarGfxToStateFlag[2][5][2] =
{
    [MALE] =
    {
        {OBJ_EVENT_GFX_AKIRA_NORMAL,     PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_AKIRA_MACH_BIKE,  PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_AKIRA_ACRO_BIKE,  PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_AKIRA_SURFING,    PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_AKIRA_UNDERWATER, PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [FEMALE] =
    {
        {OBJ_EVENT_GFX_RAN_NORMAL,         PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_RAN_MACH_BIKE,      PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_RAN_ACRO_BIKE,      PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_RAN_SURFING,        PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_RAN_UNDERWATER,     PLAYER_AVATAR_FLAG_UNDERWATER},
    }
};
...
u8 unref_GetRivalAvatarGenderByGraphicsId(u8 gfxId)
{
    switch (gfxId)
    {
    case OBJ_EVENT_GFX_RIVAL_RAN_NORMAL:
    case OBJ_EVENT_GFX_RIVAL_RAN_MACH_BIKE:
    case OBJ_EVENT_GFX_RIVAL_RAN_ACRO_BIKE:
    case OBJ_EVENT_GFX_RIVAL_RAN_SURFING:
    case OBJ_EVENT_GFX_RIVAL_RAN_FIELD_MOVE:
    case OBJ_EVENT_GFX_RAN_UNDERWATER:
    case OBJ_EVENT_GFX_RAN_FISHING:
    case OBJ_EVENT_GFX_RAN_WATERING:
        return FEMALE;
    default:
        return MALE;
    }
...
u8 GetPlayerAvatarGenderByGraphicsId(u8 gfxId)
{
    switch (gfxId)
    {
    case OBJ_EVENT_GFX_RAN_NORMAL:
    case OBJ_EVENT_GFX_RAN_MACH_BIKE:
    case OBJ_EVENT_GFX_RAN_ACRO_BIKE:
    case OBJ_EVENT_GFX_RAN_SURFING:
    case OBJ_EVENT_GFX_RAN_FIELD_MOVE:
    case OBJ_EVENT_GFX_RAN_UNDERWATER:
    case OBJ_EVENT_GFX_RAN_FISHING:
    case OBJ_EVENT_GFX_RAN_WATERING:
        return FEMALE;
