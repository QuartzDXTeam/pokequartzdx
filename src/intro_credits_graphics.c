...
static const u16 sAkiraCredits_Pal[]    = INCBIN_U16("graphics/intro/scene_2/akira_credits.gbapal");
static const u32 sAkiraCredits_Gfx[]    = INCBIN_U32("graphics/intro/scene_2/akira_credits.4bpp.lz");
...
static const struct SpriteTemplate sSpriteTemplate_Akira =
{
    .tileTag = TAG_AKIRA,
    .paletteTag = TAG_AKIRA,
    .oam = &sOamData_Player,
    .anims = sAnims_Player,
    .images = NULL,
    .affineAnims = gDummySpriteAffineAnimTable,
...
static const struct SpriteTemplate sSpriteTemplate_AkiraBicycle =
{
    .tileTag = TAG_BICYCLE,
    .paletteTag = TAG_AKIRA,
...
const struct CompressedSpriteSheet gSpriteSheet_IntroAkira[] =
{
    {
        .data = gIntroAkira_Gfx,
        .size = 0x2000,
        .tag = TAG_AKIRA
    },
    {}
...
{
    { .data = gIntroPlayer_Pal, .tag = TAG_AKIRA },
...
const struct CompressedSpriteSheet gSpriteSheet_CreditsAkira[] =
{
    {
        .data = sAkiraCredits_Gfx,
        .size = 0x3800,
        .tag = TAG_AKIRA
    },
    {}
...
{
    { .data = sAkiraCredits_Pal, .tag = TAG_AKIRA },
...
const struct CompressedSpriteSheet gSpriteSheet_CreditsRivalAkira[] =
{
    {
        .data = sAkiraCredits_Gfx,
        .size = 0x2000,
...
u8 CreateIntroAkiraSprite(s16 x, s16 y)
{
    u8 playerSpriteId = CreateSprite(&sSpriteTemplate_Akira, x, y, 2);
    u8 bicycleSpriteId = CreateSprite(&sSpriteTemplate_AkiraBicycle, x, y + 8, 3);
