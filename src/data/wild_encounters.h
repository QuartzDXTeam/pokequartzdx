...
const struct WildPokemon gBreezeWay_LandMons[] =
{
    { 2, 2, SPECIES_WURMPLE },
...
const struct WildPokemonInfo gBreezeWay_LandMonsInfo = { 20, gBreezeWay_LandMons };
...
const struct WildPokemonHeader gWildMonHeaders[] =
{
    ...
    {
        .mapGroup = MAP_GROUP(BREEZE_WAY),
        .mapNum = MAP_NUM(BREEZE_WAY),
        .landMonsInfo = &gBreezeWay_LandMonsInfo,
        .waterMonsInfo = NULL,
        .rockSmashMonsInfo = NULL,
        .fishingMonsInfo = NULL,
    },
