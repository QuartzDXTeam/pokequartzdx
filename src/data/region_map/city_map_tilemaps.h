...
const u32 gPokenavCityMap_Pink_0[] = INCBIN_U32("graphics/pokenav/city_maps/pink_0.bin.lz");
...
const u32 gPokenavCityMap_Cloudain_0[] = INCBIN_U32("graphics/pokenav/city_maps/cloudain_0.bin.lz");
