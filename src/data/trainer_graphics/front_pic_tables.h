const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_BUFFOON] = {.size = 8, .y_offset = 1},
    ...
    [TRAINER_PIC_LEADER_BETTI] = {.size = 8, .y_offset = 1},
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(BUFFOON, gTrainerFrontPic_HexManiac, 0x800),
    ...
    TRAINER_SPRITE(LEADER_BETTI, gTrainerFrontPic_LeaderBetti, 0x800),
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(BUFFOON, gTrainerPalette_HexManiac),
    ...
    TRAINER_PAL(LEADER_BETTI, gTrainerPalette_LeaderBetti),
