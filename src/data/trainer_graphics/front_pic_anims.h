...
static const union AnimCmd *const sAnims_Buffoon[] ={
    sAnim_GeneralFrame0,
};
...
static const union AnimCmd *const sAnims_LeaderBetti[] ={
    sAnim_GeneralFrame0,
};
...
static const union AnimCmd *const sAnims_Akira[] ={
    sAnim_GeneralFrame0,
};
...
static const union AnimCmd *const sAnims_RubySapphireAkira[] ={
    sAnim_GeneralFrame0,
};
...
const union AnimCmd *const *const gTrainerFrontAnimsPtrTable[] =
{
    ...
    [TRAINER_PIC_BUFFOON] = sAnims_Buffoon,
    ...
    [TRAINER_PIC_LEADER_BETTI] = sAnims_LeaderBetti,
