static const union AnimCmd gAnimCmd_Akira_1[] =
{
    ANIMCMD_FRAME(0, 24),
    ANIMCMD_FRAME(1, 9),
    ANIMCMD_FRAME(2, 24),
...
static const union AnimCmd gAnimCmd_RubySapphireAkira_1[] =
{
    ANIMCMD_FRAME(0, 24),
    ANIMCMD_FRAME(1, 9),
    ANIMCMD_FRAME(2, 24),
...
static const union AnimCmd *const sBackAnims_Akira[] =
{
    sAnim_GeneralFrame3,
    gAnimCmd_Akira_1,
};
...
static const union AnimCmd *const sBackAnims_RubySapphireAkira[] =
{
    sAnim_GeneralFrame3,
