...
{
    [HEAL_LOCATION_LITTLEROOT_TOWN_AKIRAS_HOUSE_2F - 1] = {MAP_GROUP(LITTLEROOT_TOWN_AKIRAS_HOUSE_2F), MAP_NUM(LITTLEROOT_TOWN_AKIRAS_HOUSE_2F), 4, 2},
    [HEAL_LOCATION_LITTLEROOT_TOWN_RANS_HOUSE_2F - 1] = {MAP_GROUP(LITTLEROOT_TOWN_RANS_HOUSE_2F), MAP_NUM(LITTLEROOT_TOWN_RANS_HOUSE_2F), 4, 2},
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_AKIRAS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 5, 9},
    [HEAL_LOCATION_LITTLEROOT_TOWN_RANS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 14, 9},
