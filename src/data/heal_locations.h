...
{
    [HEAL_LOCATION_BREEZE_TOWN_AKIRAS_HOUSE_2F - 1] = {MAP_GROUP(BREEZE_TOWN_AKIRAS_HOUSE_2F), MAP_NUM(BREEZE_TOWN_AKIRAS_HOUSE_2F), 4, 2},
    [HEAL_LOCATION_BREEZE_TOWN_MAYS_HOUSE_2F - 1] = {MAP_GROUP(BREEZE_TOWN_MAYS_HOUSE_2F), MAP_NUM(BREEZE_TOWN_MAYS_HOUSE_2F), 4, 2},
    [HEAL_LOCATION_PETALBURG_CITY - 1] = {MAP_GROUP(PETALBURG_CITY), MAP_NUM(PETALBURG_CITY), 15, 13},
    [HEAL_LOCATION_SLATEPORT_CITY - 1] = {MAP_GROUP(SLATEPORT_CITY), MAP_NUM(SLATEPORT_CITY), 19, 20},
    [HEAL_LOCATION_MAUVILLE_CITY - 1] = {MAP_GROUP(MAUVILLE_CITY), MAP_NUM(MAUVILLE_CITY), 14, 14},
    ...
    [HEAL_LOCATION_BREEZE_TOWN_AKIRAS_HOUSE - 1] = {MAP_GROUP(BREEZE_TOWN), MAP_NUM(BREEZE_TOWN), 24, 9},
    [HEAL_LOCATION_BREEZE_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(BREEZE_TOWN), MAP_NUM(BREEZE_TOWN), 15, 9},
    [HEAL_LOCATION_OLDALE_TOWN - 1] = {MAP_GROUP(OLDALE_TOWN), MAP_NUM(OLDALE_TOWN), 13, 17},
    [HEAL_LOCATION_DEWFORD_TOWN - 1] = {MAP_GROUP(DEWFORD_TOWN), MAP_NUM(DEWFORD_TOWN), 9, 10},
