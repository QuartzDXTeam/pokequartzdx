static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_BREEZE_TOWN_AKIRAS_HOUSE - 1] = {MAP_GROUP(BREEZE_TOWN), MAP_NUM(BREEZE_TOWN), 26, 9},
    [HEAL_LOCATION_BREEZE_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(BREEZE_TOWN), MAP_NUM(BREEZE_TOWN), 17, 9},
