static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_CLOUDAIN_CITY - 1] = {MAP_GROUP(CLOUDAIN_CITY), MAP_NUM(CLOUDAIN_CITY), 15, 13},
    ...
    [HEAL_LOCATION_PINK_TOWN - 1] = {MAP_GROUP(PINK_TOWN), MAP_NUM(PINK_TOWN), 13, 17},
    [HEAL_LOCATION_GOLDEN_ISLAND - 1] = {MAP_GROUP(GOLDEN_ISLAND), MAP_NUM(GOLDEN_ISLAND), 9, 10},
