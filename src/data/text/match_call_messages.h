...
const u8 gText_MatchCallRockinWhiz_Roxanne_Strategy[] = _("I use my intellect!");
const u8 gText_MatchCallRockinWhiz_Roxanne_Pokemon[] = _("Any Bug-type Pokémon.");
const u8 gText_MatchCallRockinWhiz_Roxanne_Intro1[] = _("I'm gonna break out of");
const u8 gText_MatchCallRockinWhiz_Roxanne_Intro2[] = _("my cocoon one day!");
