const struct Decoration gDecorations[] =
{
    ...
    [DECOR_AQUEGG_DOLL] =
    {
        .id = DECOR_AQUEGG_DOLL,
        .name = _("AQUEGG DOLL"),
        .permission = DECORPERM_SPRITE,
        .shape = DECORSHAPE_1x1,
        .category = DECORCAT_DOLL,
        .price = 3000,
        .description = DecorDesc_AQUEGG_DOLL,
        .tiles = DecorGfx_AQUEGG_DOLL,
    },
    ...
    [DECOR_PLUGOINK_DOLL] =
    {
        .id = DECOR_PLUGOINK_DOLL,
        .name = _("Plug-Oink Doll"),
        .permission = DECORPERM_SPRITE,
        .shape = DECORSHAPE_1x1,
        .category = DECORCAT_DOLL,
        .price = 3000,
        .description = DecorDesc_PLUGOINK_DOLL,
        .tiles = DecorGfx_PLUGOINK_DOLL,
    },
    ...
    [DECOR_ROELLAMA_DOLL] =
    {
        .id = DECOR_ROELLAMA_DOLL,
        .name = _("Roellama Doll"),
        .permission = DECORPERM_SPRITE,
        .shape = DECORSHAPE_1x2,
        .category = DECORCAT_DOLL,
        .price = 10000,
        .description = DecorDesc_ROELLAMA_DOLL,
        .tiles = DecorGfx_ROELLAMA_DOLL,
    },
    ...
    [DECOR_COLOSSIO_DOLL] =
    {
        .id = DECOR_COLOSSIO_DOLL,
        .name = _("Colossio Doll"),
        .permission = DECORPERM_SPRITE,
        .shape = DECORSHAPE_1x2,
        .category = DECORCAT_DOLL,
        .price = 10000,
        .description = DecorDesc_COLOSSIO_DOLL,
        .tiles = DecorGfx_COLOSSIO_DOLL,
    },
