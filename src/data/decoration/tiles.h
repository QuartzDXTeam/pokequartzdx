...
const u16 DecorGfx_PLUGOINK_DOLL[] = {
    OBJ_EVENT_GFX_PLUGOINK_DOLL
};
...
const u16 DecorGfx_ROELLAMA_DOLL[] = {
    OBJ_EVENT_GFX_ROELLAMA_DOLL
};
...
const u16 DecorGfx_COLOSSIO_DOLL[] = {
    OBJ_EVENT_GFX_COLOSSIO_DOLL
};
