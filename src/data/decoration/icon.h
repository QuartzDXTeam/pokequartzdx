const u32 *const gDecorIconTable[][2] =
{
    ...
    [DECOR_ROELLAMA_DOLL]  = {gDecorIcon_RoellamaDoll, gDecorIconPalette_RoellamaDoll},
    [DECOR_BLASTOISE_DOLL]  = {gDecorIcon_BlastoiseDoll, gDecorIconPalette_BlastoiseDoll},
    [DECOR_COLOSSIO_DOLL]    = {gDecorIcon_ColossioDoll, gDecorIconPalette_ColossioDoll},
