const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_AKIRA] = TRAINER_PIC_AKIRA,
    [FACILITY_CLASS_AKIRA_2] = TRAINER_PIC_AKIRA,
    [FACILITY_CLASS_AKIRA_3] = TRAINER_PIC_AKIRA,
    [FACILITY_CLASS_RAN] = TRAINER_PIC_RAN,
    [FACILITY_CLASS_RAN_2] = TRAINER_PIC_RAN,
    [FACILITY_CLASS_RAN_3] = TRAINER_PIC_RAN,
    ...
    [FACILITY_CLASS_RS_AKIRA] = TRAINER_PIC_RS_AKIRA,
    [FACILITY_CLASS_RS_RAN] = TRAINER_PIC_RS_RAN,
};
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_AKIRA] = TRAINER_CLASS_PKMN_TRAINER_3,
    [FACILITY_CLASS_AKIRA_2] = TRAINER_CLASS_PKMN_TRAINER_3,
    [FACILITY_CLASS_AKIRA_3] = TRAINER_CLASS_PKMN_TRAINER_3,
    [FACILITY_CLASS_RAN] = TRAINER_CLASS_PKMN_TRAINER_3,
    [FACILITY_CLASS_RAN_2] = TRAINER_CLASS_PKMN_TRAINER_3,
    [FACILITY_CLASS_RAN_3] = TRAINER_CLASS_PKMN_TRAINER_3,
    ...
    [FACILITY_CLASS_RS_AKIRA] = TRAINER_CLASS_RS_PROTAG,
    [FACILITY_CLASS_RS_RAN] = TRAINER_CLASS_RS_PROTAG,
};
