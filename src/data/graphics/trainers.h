...
const u32 gTrainerFrontPic_LeaderBetti[] = INCBIN_U32("graphics/trainers/front_pics/leader_betti_front_pic.4bpp.lz");
const u32 gTrainerPalette_LeaderBetti[] = INCBIN_U32("graphics/trainers/palettes/leader_betti.gbapal.lz");
