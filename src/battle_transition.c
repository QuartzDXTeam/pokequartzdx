...
static const u8 sUnusedAkira_Gfx[] = INCBIN_U8("graphics/battle_transitions/unused_akira.4bpp");
...
static const struct OamData sOam_UnusedAkiraLass =
{
    .y = 0,
...
static const struct SpriteFrameImage sImageTable_UnusedAkira[] =
{
    sUnusedAkira_Gfx, sizeof(sUnusedAkira_Gfx)
};
...
static const union AnimCmd sSpriteAnim_UnusedAkiraLass[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END
};

static const union AnimCmd *const sSpriteAnimTable_UnusedAkiraLass[] =
{
    sSpriteAnim_UnusedAkiraLass
};

static const struct SpriteTemplate sSpriteTemplate_UnusedAkira =
{
    .tileTag = 0xFFFF,
    .paletteTag = 0x100A,
    .oam = &sOam_UnusedAkiraLass,
    .anims = sSpriteAnimTable_UnusedAkiraLass,
    .images = sImageTable_UnusedAkira,
