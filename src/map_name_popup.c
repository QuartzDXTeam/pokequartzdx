...
{
    [MAPSEC_BREEZE_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_PINK_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_GOLDEN_ISLAND] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_CLOUDAIN_CITY] = MAPPOPUP_THEME_BRICK,
    ...
    [MAPSEC_BREEZE_WAY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CLOUD_WAY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROCK_CANYON] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CLOUD_BEACH] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_BROKE_SEA] = MAPPOPUP_THEME_UNDERWATER,
    ...
    [MAPSEC_BROWN_HILL] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_DARKNESS_FOREST] = MAPPOPUP_THEME_WOOD,
