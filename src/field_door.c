...
static const u8 sDoorAnimTiles_BarosLab[] = INCBIN_U8("graphics/door_anims/baros_lab.4bpp");
...
static const u8 sDoorAnimTiles_Pink[] = INCBIN_U8("graphics/door_anims/pink.4bpp");
...
static const u8 sDoorAnimPalettes_BarosLab[] = {8, 8, 8, 8, 8, 8, 8, 8};
...
static const u8 sDoorAnimPalettes_Pink[] = {10, 10, 9, 9, 9, 9, 9, 9};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_Cloudain_Door_Littleroot,                    DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_Littleroot, sDoorAnimPalettes_Littleroot},
    {METATILE_Cloudain_Door_BarosLab,                     DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_BarosLab, sDoorAnimPalettes_BarosLab},
    ...
    {METATILE_Cloudain_Door_Pink,                        DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_Pink, sDoorAnimPalettes_Pink},
