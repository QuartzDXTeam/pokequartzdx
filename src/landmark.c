...
static const u8 LandmarkName_DarknessForest[] = _("CLOUDAIN WOODS");
static const u8 LandmarkName_MsBritneysCottage[] = _("MR. BRITNEY'S COTTAGE");
...
static const struct Landmark Landmark_DarknessForest = {LandmarkName_DarknessForest, -1};
static const struct Landmark Landmark_MsBritneysCottage = {LandmarkName_MsBritneysCottage, FLAG_LANDMARK_MS_BRITNEY_HOUSE};
...
static const struct Landmark *const Landmarks_RockCanyon_2[]  =
{
    &Landmark_AlteringCave,
    NULL,
};

static const struct Landmark *const Landmarks_CloudBeach_0[]  =
{
    &Landmark_FlowerShop,
    NULL,
};

static const struct Landmark *const Landmarks_CloudBeach_1[]  =
{
    &Landmark_DarknessForest,
    &Landmark_MsBritneysCottage,
    NULL,
};

static const struct Landmark *const Landmarks_BrokeSea_0[]  =
{
    &Landmark_IslandCave,
    NULL,
};
...
static const struct Landmark *const Landmarks_BrownHill_0[]  =
{
    &Landmark_OldLadysRestShop,
    NULL,
};

static const struct Landmark *const Landmarks_BrownHill_1[]  =
{
    &Landmark_Desert,
    NULL,
};

static const struct Landmark *const Landmarks_BrownHill_2[]  =
{
...
static const struct Landmark *const Landmarks_BrownHill_3[]  =
{
...
static const struct Landmark *const Landmarks_BrownHill_4[]  =
{
...
{
    {MAPSEC_ROCK_CANYON, 2, Landmarks_RockCanyon_2},
    {MAPSEC_CLOUD_BEACH, 0, Landmarks_CloudBeach_0},
    {MAPSEC_CLOUD_BEACH, 1, Landmarks_CloudBeach_1},
    {MAPSEC_BROKE_SEA, 0, Landmarks_BrokeSea_0},
    ...
    {MAPSEC_BROWN_HILL, 0, Landmarks_BrownHill_0},
    {MAPSEC_BROWN_HILL, 1, Landmarks_BrownHill_1},
    {MAPSEC_BROWN_HILL, 2, Landmarks_BrownHill_2},
    {MAPSEC_BROWN_HILL, 3, Landmarks_BrownHill_3},
    {MAPSEC_BROWN_HILL, 4, Landmarks_BrownHill_4},
