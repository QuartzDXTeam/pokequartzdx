...
static const u8 LandmarkName_CloudainWoods[] = _("CLOUDAIN WOODS");
...
static const struct Landmark Landmark_CloudainWoods = {LandmarkName_CloudainWoods, -1};
