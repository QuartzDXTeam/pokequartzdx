...
const u8 gText_ExpandedPlaceholder_Ran[] = _("Ran");
...
const u8 gText_DexHoennTitle[] = _("CORNA DEX");
...
const u8 gText_MatchCallRan_Strategy[] = _("I'm not so good at battles.");
const u8 gText_MatchCallRan_Pokemon[] = _("I'll use any POKéMON!");
const u8 gText_MatchCallRan_Intro1[] = _("My POKéMON and I help");
const u8 gText_MatchCallRan_Intro2[] = _("my father's research.");
...
const u8 gText_RanAkiraMatchCallDesc[] = _("RAD NEIGHBOR");
