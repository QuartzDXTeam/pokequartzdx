...
const u8 gText_Littleroot[] = _("BREEZE"); // Unused. Given the context, Briney may at one point have been able to sail the player here
...
const u8 gText_MsBritney[] = _("MR. BRITNEY"); // Unused
