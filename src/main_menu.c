 ...
 * Task_NewGameBirchSpeech_StartBirchPlug_OinkPlatformFade
 * Task_NewGameBirchSpeech_StartBirchPlug_OinkPlatformFade
 ...
 * Task_NewGameBirchSpeech_ReshowBirchPlug_Oink
 ...
 *  - Advances to Task_NewGameBirchSpeechSub_WaitForPlug_Oink
 * Task_NewGameBirchSpeechSub_WaitForPlug_Oink
...
static void Task_NewGameBirchSpeechSub_WaitForPlug_Oink(u8);
static void Task_NewGameBirchSpeech_StartBirchPlug_OinkPlatformFade(u8);
...
static void Task_NewGameBirchSpeech_ReshowBirchPlug_Oink(u8);
...
{
    u8 spriteId = gTasks[sBirchSpeechMainTaskId].tPlug_OinkSpriteId;
    ...
    gTasks[taskId].func = Task_NewGameBirchSpeechSub_WaitForPlug_Oink;
    gTasks[sBirchSpeechMainTaskId].tTimer = 0;
}

static void Task_NewGameBirchSpeechSub_WaitForPlug_Oink(u8 taskId)
{
    s16 *data = gTasks[taskId].data;
    struct Sprite *sprite = &gSprites[gTasks[sBirchSpeechMainTaskId].tPlug_OinkSpriteId];
...
static void Task_NewGameBirchSpeech_AndYouAre(u8 taskId)
{
    if (!RunTextPrintersAndIsPrinter0Active())
    {
        ...
        AddTextPrinterForMessage(1);
        gTasks[taskId].func = Task_NewGameBirchSpeech_StartBirchPlug_OinkPlatformFade;
    }
}

static void Task_NewGameBirchSpeech_StartBirchPlug_OinkPlatformFade(u8 taskId)
{
    if (!RunTextPrintersAndIsPrinter0Active())
    {
...
static void Task_NewGameBirchSpeech_SlidePlatformAway2(u8 taskId)
{
    ...
    {
        gTasks[taskId].func = Task_NewGameBirchSpeech_ReshowBirchPlug_Oink;
    }
}

static void Task_NewGameBirchSpeech_ReshowBirchPlug_Oink(u8 taskId)
{
    u8 spriteId;
...
static u8 NewGameBirchSpeech_CreatePlug_OinkSprite(u8 a, u8 b)
{
...
static void AddBirchSpeechObjects(u8 taskId)
{
    ...
    lotadSpriteId = NewGameBirchSpeech_CreatePlug_OinkSprite(100, 0x4B);
