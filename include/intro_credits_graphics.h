...
extern const struct CompressedSpriteSheet gSpriteSheet_IntroAkira[];
...
extern const struct CompressedSpriteSheet gSpriteSheet_CreditsAkira[];
...
extern const struct CompressedSpriteSheet gSpriteSheet_CreditsRivalAkira[];
