...
gStdScripts_End:: @ 81DC2CC
	...
	.include "data/maps/BrownHill/scripts.inc"
	...
	.include "data/maps/BrownHill_WinstrateFamilysHouse/scripts.inc"
	.include "data/maps/BrownHill_OldLadysRestStop/scripts.inc"
...
EventScript_MoveMsBritneyToDewford:: @ 827189A
	setflag FLAG_HIDE_ROUTE_109_MS_BRITNEY
	setflag FLAG_HIDE_ROUTE_109_MS_BRITNEY_BOAT
	setflag FLAG_HIDE_CLOUD_BEACH_MS_BRITNEY
...
Common_EventScript_UpdateBrineyLocation:: @ 82718DE
	...
	goto_if_unset FLAG_HIDE_CLOUD_BEACH_MS_BRITNEY_BOAT, EventScript_SetBrineyLocation_House
	goto_if_unset FLAG_HIDE_MS_BRITNEY_GOLDEN_ISLAND, EventScript_SetBrineyLocation_Dewford
	goto_if_unset FLAG_HIDE_ROUTE_109_MS_BRITNEY, EventScript_SetBrineyLocation_Route109
	return

EventScript_SetBrineyLocation_House:: @ 827190C
	setvar VAR_BRITNEY_LOCATION, 1
	return

EventScript_SetBrineyLocation_Dewford:: @ 8271912
	setvar VAR_BRITNEY_LOCATION, 2
	return

EventScript_SetBrineyLocation_Route109:: @ 8271918
	setvar VAR_BRITNEY_LOCATION, 3
	return
...
EventScript_BackupMsBritneyLocation:: @ 8271E95
	copyvar VAR_0x8008, VAR_BRITNEY_LOCATION
	setvar VAR_BRITNEY_LOCATION, 0
	return
